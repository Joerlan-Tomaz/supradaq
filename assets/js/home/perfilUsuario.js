...
function alteraSobreMim() {
    ...
    //-----------------------------------------------------------
    bootbox.confirm("Confima operação [INSERIR SOBRE MIM]?", function (result) {
        if (result === true) {
            $.ajax({
                type: 'POST',
...
function gravaPerfilMensagem() {
    ...
    bootbox.confirm("Confima operação [INSERIR MENSAGEM]?", function (result) {
        if (result === true) {
...
function GravaResposta(id_mensagem, id_destinatario, id_remetente) {
    ...
    bootbox.confirm("Confima operação [INSERIR RESPOSTA]?", function (result) {
        if (result === true) {
...
function excluirResposta(id_resposta, id_mensagem) {
    bootbox.confirm("Confima operação [EXCLUIR MENSAGEM]?", function (result) {
        if (result === true) {
