...
<!--									<dd>--><?//= $extensao_localizacao; ?><!--</dd>-->
						...
						<td colspan="9">
							<div class="col-md-12 center">
								<h2><b>RELATÓRIO FLUVIOMÉTRICO</b></h2>
							</div>
						</td>
					</tr>
					<tr>
	...
	<section id="anexos" class="sheet padding-10mm">
		...
		<div id="anexo_resumo">
			<div class="row">
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 bold">
					<h3>
						<strong>24.1 RESUMO DE PROJETO</strong>
					</h3>
				</div>
			</div>
			<br>
...
<!--				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 bold">-->
<!--					<h3>-->
<!--						<strong>24.2 RPFO - Revisão de projetos em fase de obra-->
<!--						</strong>-->
<!--					</h3>-->
<!--				</div>-->
<!--			</div>-->
...
//							}
//							$arquivo = 'homeDaq/Supervisaodaq/Arquivo/DownloadArquivo?arq=' . $key->nome_arquivo;
//							?>
<!--							<tr>-->
