<script src="<?php echo(base_url('application/homeDaq/homeCgop/assets/js/supervisaodaq/portariasfiscais/portariasfiscaisView.js'))?>" type="text/javascript"></script>
        ...
        <div class="container-fluid">
            <div class="card card-default">
                <div class="card-header">
                    <h2>
                        <font size="3">                        
                        Devem ser anexadas as portarias de designação dos fiscais do DNIT responsáveis pela fiscalização dos contratos de supervisão e das operações hidroviárias.
                                ...
                                <div class="col-md-4"> 
                                    <div class="form-group">
                                        ...
                                        <div class="input-group date">
                                            ...
                                            <input id="telefone" name="telefone" class="form-control" type="tel" onclick="mascaraTelefone(this.value)">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
