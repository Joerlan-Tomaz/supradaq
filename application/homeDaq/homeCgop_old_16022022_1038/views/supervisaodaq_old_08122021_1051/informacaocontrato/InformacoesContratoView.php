<link rel="stylesheet" href="<?php echo(base_url('application/homeDaq/homeCgop/assets/css/homeCgcont/ambientegestao/ambientegestao.css'))?>" />
<script src="<?php echo(base_url('application/homeDaq/homeCgop/assets/js/supervisaodaq/info/infoView.js'))?>" type="text/javascript"></script>  
            ...
            <div class="row mb-2">
                ...
                <div class="col-md-4">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Dados Contrato: <?php echo $this->session->numero_contrato ?></li>
                    </ol>
                </div>
            </div>
        </div>
