...
<div class="content-wrapper">
	...
	<section class="content-header">
		<div class="container-fluid">
			<div class="row mb-2">
				<div class="col-sm-6">
					<h1>Atividades da Executora - Manutenção</h1>
				</div>
				<div class="col-sm-6">
					<ol class="breadcrumb float-sm-right">
						...
						<li class="breadcrumb-item active">Atividades da Executora - Manutenção</li>
					</ol>
				</div>
			</div>
		</div><!-- /.container-fluid -->
					...
					<form method="post" name="formulario">
						<h2>
							<font size="3">
								...
								executora no âmbito de Manutenção.
				...
				<div class="card-body">
					...
					<div id="cadastroAtividadesExecutora">
						<form method="post" name="formularioAtividadesExecutora" id="formularioAtividadesExecutora">
							<input type="hidden" name="tipo_atividade" id="tipo_atividade" value="Manutenção">
							<div class="row">
								<div class="col-md-12">
							...
							<div class="row">
								<div class="col-md-3">
									<div class="form-group">
										<a href="<?php echo base_url("index_cgob.php/Supervisaodaq/Arquivo/Modelo") ?>?arq=Modelo de Formulário Manutenção.xlsx" download><span class="right badge badge-info">Baixe o modelo de planilha IP4</span></a>
									</div>
								</div>
							</div>
							<div class="row">
								<div class="col-md-3">
									<div class="form-group">
										<a href="<?php echo base_url("index_cgob.php/Supervisaodaq/Arquivo/Modelo") ?>?arq=Modelo de Formulário Manutenção - eclusas.xlsx" download><span class="right badge badge-info">Baixe o modelo de planilha Eclusa</span></a>
									</div>
								</div>
							</div>
							<div class="row">
