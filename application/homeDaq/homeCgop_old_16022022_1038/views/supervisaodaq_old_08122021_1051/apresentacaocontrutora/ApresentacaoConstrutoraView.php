<script src="<?php echo(base_url('application/homeDaq/homeCgop/assets/js/supervisaodaq/apresentacaoconstrutora/apresentacaoconstrutoraView.js'))?>" type="text/javascript"></script>
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Apresentação Executora</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
            ...
            <div class="card card-default">
                <div class="card-header">
                    <form method="post" name="formulario">
                        <h2>
                            <font size="3">Nesta seção devem ser fornecidas, as informações referentes à identificação da operação.
                            </font>
                        </h2>
                        <div class="row">
