<script src="<?php echo(base_url('application/homeDaq/homeCgop/assets/js/supervisaodaq/mobilizacaosupervisora/mobilizacaosupervisoraView.js'))?>" type="text/javascript"></script>	
