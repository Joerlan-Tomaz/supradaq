<script src="<?php echo(base_url('application/homeDaq/homeCgop/assets/js/supervisaodaq/justificativaempreendimento/justificativaempreendimentoView.js'))?>" type="text/javascript"></script>
        ...
        <div class="container-fluid">
            <div class="card card-default">
                <div class="card-header">
                    <h2>
                        <font size="3">Descrever de forma clara a importância das infraestruturas para a região, informando todos os municípios impactados,
                        direta ou indiretamente pelo empreendimento,
							<div class='ocultar'><u>[+/-] Leia mais...</u></div>
                        <div class='mostrar'> 
                            Ou seja, os municípios que se beneficiam com a operação,
                            seja com a geração de empregos, maior mobilidade, aquecimento da economia local, dentre outros.</div>
                        </font>
                    </h2>
                    <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
										...
										<input type="hidden" name="id_tela_formulario" id="id_tela_formulario" value="1"/>
                                    </div>
                                </div>
                            </div>
                        </form>
