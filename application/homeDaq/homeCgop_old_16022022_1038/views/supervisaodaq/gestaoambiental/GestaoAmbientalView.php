...
<script src="<?php echo(base_url('application/homeDaq/homeCgop/assets/js/supervisaodaq/gestaoambiental/gestaoambientalView.js')) ?>" type="text/javascript"></script>
<!--GESTAO AMBIENTAL-->
<script src="<?php echo(base_url('application/homeDaq/homeCgop/assets/js/supervisaodaq/licencasambientais/licencasambientais.js')) ?>" type="text/javascript"></script>
<script src="<?php echo(base_url('application/homeDaq/homeCgop/assets/js/supervisaodaq/pbapbai/pbapbai.js')) ?>" type="text/javascript"></script>
                    ...
                    <div class="col-xs-12 col-md-6">
                        <ul class="list-unstyled">
                            <li class="justificativa">
                                ...
                                <a href="javascript:void(0);" onclick="rotaLicencasAmbientaisDaq()"><span>Licenças</span></a>
                                <span class="road-status"></span>
                            </li>
                            <li class="mapa">
                                <span class="road-ico"><img src="<?php echo(base_url('assets/img/road/mapa.png'))?>" /></span>
                                <a href="javascript:void(0);" onclick="rotaPbaPbaiDaq()"><span>Planos Ambientais e outros</span></a>
                                <span class="road-status"></span>
                            </li>
                        </ul>
                    </div>
                    <div class="col-xs-12 col-md-6">
                        <div class="road-info">
                            <div class="box-info">
                                ...
                                <span id="checkLicencaAmbiental" class="badge badge-secondary" style="border-radius: 50px; box-shadow: 1px 3px 7px #545454; margin: 0px 10px;" data-toggle="tooltip" title="Pendente" data-placement="top"><i class="fa fa-check"></i></span> Licença<br>
                                <span id="checkPBAPBAI" class="badge badge-secondary" style="border-radius: 50px; box-shadow: 1px 3px 7px #545454; margin: 0px 10px;" data-toggle="tooltip" title="Pendente" data-placement="top"><i class="fa fa-check"></i></span> Planos Ambientais e outros<br>
                            </div>
                        </div>
                    </div>
                </div>
