<script src="<?php echo(base_url('application/homeDaq/homeCgop/assets/js/supervisaodaq/mobilizacaosupervisora/mobilizacaosupervisoraView.js')) ?>"
			...
			<div class="card card-default">
				<div class="card-header">
					<form method="post" name="formulario">
						<h6>
							Devem ser informadas as equipes disponibilizadas para a realização das atividades que
							constituem o
							Plano de Trabalho contratual da empresa supervisora.
							<div class='ocultar'><u>[+/-] Leia mais...</u></div>
							<div class='mostrar'>
								Qualquer mudança em relação ao disposto na proposta contratual deve ser comunicada no
								relatório.<br>
								O pessoal e equipamentos contratados pela supervisora através de subempreiteiras e que
								executaram serviços diretamente relacionados
				...
				<div class="card-body">
						...
						<div class="col-md-12" style="font-size: small">
							<table id="tableRelacaoMobilizacao" class="table table-striped">
								...
								<tr>
									...
									<th style="width: 58px;">Infraestrutura</th>
					...
					<div class="row" id="cadastroRelacaoMobilizacao">
						...
						<div class="col-md-3">
							<div class="form-group">
								...
								<select id="nome_infraestrutura" name="nome_infraestrutura"
					...
					<div class="row" id="tableRelacao">
						...
						<div class="col-md-1">
							<button type="button" name="insereRelacaoMobilizacao" id="insereRelacaoMobilizacao"
