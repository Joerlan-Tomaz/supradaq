<script src="<?php echo(base_url("application/homeDaq/homeCgop/assets/js/supervisaodaq/riscosinterferencias/riscosinterferenciasView.js")) ?>"
			...
			<div class="card card-default">
				<div class="card-header">
					<form method="post" name="formulario">
						<h2>
							<font size="3">
								Deve ser realizada a gestão de toda e qualquer situação que possa impactar a operação,
								tais como restrições ambientais,
								interferências com serviços públicos, restrição financeira, paralização dos serviços,
								entre outros.
								<div class='ocultar'><u>[+/-] Leia mais...</u></div>
								<div class='mostrar'>
									Resumo: informar, de forma clara e concisa, os impactos e principais tratativas
									referentes às interferências.
									Realizar análise crítica quanto à relevância das interferências no atendimento ao
									término contratual.
									Descrever a situação atual do risco, com quais ações já foram tomadas até o momento
									para minimizar/sanar o risco.<br>
									As informações deverão ser apresentadas nos relatórios de acompanhamento,
									até o Relatório do mês de referência em que foram classificadas como sanadas ou
									mitigadas/não ocorridas.
								</div>
							</font>
						</h2>
						<div class="row">
				...
				<div class="card-body">
					...
					<div id="cadastroInterferencia" style="display: none">
						<form method="post" class="submitAjax" name="formularioInterferencia"
							  id="formularioInterferencia">
							<div class="row">
								<div class="col-12 col-md-12">
									<div class="row">
										...
										<div class="col-md-3">
											<div class="form-group">
												<label>Tipo</label>
												<select class="form-control" name="tipoInterferencia"
														id="tipoInterferencia"></select>
											</div>
										</div>
										...
										<div class="col-md-6">
											<div class="form-group">
												<label>Grau de Impacto <b class="description-header"
																		  style="font-size: 15px;"><span
																class="label_grau_impacto"
																style="font-size: 15px;"></span></b></i></label>
										...
										<div class="col-md-6">
											...
											<div class="input-group date">
												...
												<input id="previsaoSolucao" name="previsaoSolucao" type="text"
										...
										<div class="col-md-6">
											...
											<div class="input-group date">
												...
												<input id="dataLimite" name="dataLimite" type="text"
													   data-provide="datepicker" class="datepicker form-control"
													   required="true">
											</div>
										</div>
										...
										<div class="col-md-6">
											<div class="form-group">
												<label>Resumo</label>
												<textarea id="resumoInterferencias" name="resumoInterferencias" rows="2"
										...
										<div class="col-md-6">
											<div class="form-group">
												...
												<textarea id="providencia" name="providencia" rows="2"
														  style="min-width: 100%"></textarea>
											</div>
										</div>
									</div>
						...
						<div class="col-md-1">
							<button type="button" class="btn btn-block btn-primary" id="insereInterferencia"
									name="insereInterferencia">Salvar
							</button>
						</div>
					</div>
				...
				<div id="EditarcadastroInterferencia" style="display: none">
					<hr>
					<div class="card-body">
						<form method="post" class="submitAjax" name="formularioInterferenciaEditar"
							  id="formularioInterferenciaEditar">
							<div class="row">
								<div class="col-12 col-md-12">
									<div class="row">
										<div class="col-md-6">
											<div class="form-group">
												<label>Assunto</label>
												<input id="descricaoEditar" name="descricaoEditar" class="form-control"
													   type="text">
											</div>
										</div>
										<div class="col-md-6">
											<div class="form-group">
												<label>Tipo</label>
												<select class="form-control" name="tipoInterferenciaEditar"
														id="tipoInterferenciaEditar"></select>
											</div>
										</div>
										<div class="col-md-6">
											<div class="form-group">
												<label>Classificação</label>
												<select class="form-control" name="classificacaoEditar"
														id="classificacaoEditar">
												</select>
											</div>
										</div>
										<div class="col-md-6">
											<div class="form-group">
												<label>Grau de Impacto <b class="description-header"
																		  style="font-size: 15px;"><span
																class="label_grau_impacto_editar"
																style="font-size: 15px;"></span></b></i></label>
												<select class="form-control" name="grauImpactoEditar"
														id="grauImpactoEditar">
												</select>
											</div>
										</div>
										<div class="col-md-6">
										...
										<div class="col-md-6">
											...
											<div class="input-group date">
												...
												<input id="previsaoSolucaoEditar" name="previsaoSolucaoEditar"
										...
										<div class="col-md-6">
											...
											<div class="input-group date">
												...
												<input id="dataLimiteEditar" name="dataLimiteEditar" type="text"
													   data-provide="datepicker" class="datepicker form-control"
													   required="true">
											</div>
										</div>
										<div class="col-md-6">
											<div class="form-group">
												<label>Impacto de Custo</label>
												<select id="impactoCustoEditar" name="impactoCustoEditar"
														class="form-control">
													<option value="">Selecione</option>
													<option value="1">Sim</option>
													<option value="0">Não</option>
										...
										<div class="col-md-6">
											<div class="form-group">
												<label>Impacto de Prazo</label>
												<select id="impactoPrazoEditar" name="impactoPrazoEditar"
														class="form-control">
													<option value="">Selecione</option>
													<option value="1">Sim</option>
													<option value="0">Não</option>
										...
										<div class="col-md-6">
											<div class="form-group">
												<label>Resumo</label>
												<textarea id="resumoInterferenciasEditar"
														  name="resumoInterferenciasEditar" rows="2"
														  style="min-width: 100%"></textarea>
											</div>
										</div>
										<div class="col-md-6">
											<div class="form-group">
												<label>Providência</label>
												<textarea id="providenciaEditar" name="providenciaEditar" rows="2"
														  style="min-width: 100%"></textarea>
											</div>
										</div>
									</div>
						...
						<div class="col-md-1">
							<button type="button" class="btn btn-block btn-primary" id="editarInterferencia"
									name="editarInterferencia">Editar
							</button>
				...
				<form method="post" name="formProvidenciaInterferencia" id="formProvidenciaInterferencia">
					<div class="row">
						...
						<div class="col-md-12">
							<div class="form-group">
								<label>Providência</label>
								<textarea id="providenciaInterferencia" name="providenciaInterferencia" rows="5"
										  style="min-width: 100%"></textarea>
							</div>
						</div>
						<div class="col-md-12">
							<button type="button" class="btn btn-primary" id="btnInsereSolucaoInterferencia"
									onclick="insereProvidencia();">Salvar
							</button>
						</div>
						<div class="col-md-12">
							<div class="form-group">
