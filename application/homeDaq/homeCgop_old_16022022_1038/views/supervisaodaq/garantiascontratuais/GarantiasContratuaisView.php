...
<script src="<?php echo(base_url('application/homeDaq/homeCgop/assets/js/supervisaodaq/garantiascontratuais/garantiascontratuaisView.js')) ?>" type="text/javascript"></script>  	
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Garantias e Seguros</li>
                    </ol>
                </div>
            </div>
        </div>
                ...
                <div class="card-header">
                    <h2>
                       ...
                       Neste item devem ser tratados os termos das garantias contratuais (apólice/endosso de seguro, caução ou fiança) e,
                        ...
                        <div class='mostrar'> 
                        se aplicável ao contrato, as demais “garantias do empreendimento”, tais como apólices/endossos de seguro risco rngenharia, responsabilidade civil e responsabilidade profissional, tanto para os contratos de Supervisão quanto para os supervisionados/gerenciados. ​
