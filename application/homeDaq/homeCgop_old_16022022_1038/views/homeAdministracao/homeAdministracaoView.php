<script src="<?php echo (base_url('application/homeDaq/homeCgop/assets/js/administracao/rotas.js')) ?>"></script>
<script src="<?php echo (base_url('application/homeDaq/homeCgop/assets/js/administracao/solicitaoacesso/solicitacaoacessoView.js')) ?>"></script>
<script src="<?php echo (base_url('application/homeDaq/homeCgop/assets/js/administracao/atualizarperfilpermissoes/atualizarperfilpermissoesView.js')) ?>"></script>
<script src="<?php echo (base_url('application/homeDaq/homeCgop/assets/js/administracao/novasupervisora/novasupervisoraView.js')) ?>"></script>
<script src="<?php echo (base_url('application/homeDaq/homeCgop/assets/js/administracao/relacionargrupocontrato/relacionargrupocontratoView.js')) ?>"></script>
<script src="<?php echo (base_url('application/homeDaq/homeCgop/assets/js/administracao/relarionausuariocontrato/relarionausuariocontratoView.js')) ?>"></script>
<script src="<?php echo (base_url('application/homeDaq/homeCgop/assets/js/administracao/resetarbloquearsenha/resetarbloquearsenhaView.js')) ?>"></script>
<script src="<?php echo (base_url('application/homeDaq/homeCgop/assets/js/administracao/alterausuario/alterausuarioView.js')) ?>"></script>
<script src="<?php echo (base_url('application/homeDaq/homeCgop/assets/js/administracao/usuariosonline/usuariosonlineView.js')) ?>"></script>
<script src="<?php echo (base_url('application/homeDaq/homeCgop/assets/js/administracao/codsicro/codsicroView.js')) ?>"></script>
<script src="<?php echo (base_url('application/homeDaq/homeCgop/assets/js/administracao/mapasituacao/mapaSituacaoView.js')) ?>"></script>
<script src="<?php echo (base_url('application/homeDaq/homeCgop/assets/js/administracao/cgplan/cgplanView.js')) ?>"></script>

<script src="<?php echo (base_url('application/homeDaq/homeCgop/assets/js/administracao/telas/telas.js')) ?>"></script>
