...
class Tb_telas_validacao extends CI_Model
{
	...
	public function BuscaValidacao($dados){
		$SQL = "SELECT tv.*, us.*, us2.DESC_NOME as nome_analise,
       			concat( CONVERT(CHAR(10),tv.data_ultima_alteracao , 103),' ', CONVERT(CHAR(8),tv.data_ultima_alteracao , 114)) AS ultima_alteracao,	
       			concat( CONVERT(CHAR(10),tv.data_analise , 103),' ', CONVERT(CHAR(8),tv.data_analise , 114)) AS data_ultima_analise	
		...
		if($dados['validacao_unica'] == 'N'){
			$SQL .= "AND tv.periodo = '" . $dados["periodo"] . "'";
		}

		$SQL .= " ORDER BY data_ultima_alteracao DESC";
