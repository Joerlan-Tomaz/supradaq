...
#------------------------------------------------------------------------------#    
    public function home_Daq(){
     ...
     //  $data = array('Codigo' => "0", 'CodigoAviso' => "0", 'IdPerfil' => $this->session->id_perfil, 'idUsuario' => $this->session->id_usuario_daq);
       /* $this->load->database();
        $this->load->model("Tb_usuario");
       ...
       // $this->load->model("Tb_usuario");
        ...
        $data = array('Codigo' => "0", 'CodigoAviso' => "0", 'IdPerfil' => $id_perfil_daq , 'idUsuario' => $this->session->id_usuario_daq_cgop);
        ...
        if ($qntPerfisCOORDENACOES == 1){
            ...
            if ($id_perfil_daq == 9 or $id_perfil_daq == 5 or $id_perfil_daq == 4 or $id_perfil_daq == 3)
            {
            ...
            if ($id_perfil_daq == 1 or $id_perfil_daq == 2)
            {
                $this->load->view("homeSupervisaoDaq", $data);
            }
        }
...
public function homeCgob(){
	...
	$dados['id_usuario_daq_cgop'] = $this->session->id_usuario;
