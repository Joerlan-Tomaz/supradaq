     ...
     public function recuperaPontoPassagem() {
        ...
        if (!empty($dadosGeo)) {
            foreach ($dadosGeo as $lista) {
               ...
               // $arquivo = "<a href='javascript:void(0);' onclick=\"anexoPontoPass('{$lista->nome_arquivo}')\">" . $nomeArquivo . "</a>";
...
//------------------------------------------------------------------------------------------------------------------------
    ...
    public function anexoPontoPass() {
        $nome_arquivo = $this->input->post_get('nome_arquivo');
    ...
    public function ModeloPontoPassagem() {
        $nome_arquivo = $this->input->post_get('nome_arquivo');
        $config['hostname'] = '10.100.11.158';
        $config['username'] = 'supradaq';
        $config['password'] = 'dnit@2020';
