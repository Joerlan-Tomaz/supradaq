    ...
    public function RecuperaAnexos() {
        ...
        if (!empty($Dados)) {
            foreach ($Dados as $i => $lista) {
                ...
                //$arquivo = "<a href='javascript:void(0);' onclick=\"anexorecupera('{$lista->nome_arquivo}')\">" . $nomeArquivo . "</a>";
                ...
                $retorno["data"][] = array(
                    'ARQUIVO' => $arquivo,
                    'TIPOARQUIVO'=>$lista->desc_arquivo,
                    'NOME' => $lista->nome,
