...
class PGQ extends CI_Controller {
    ...
    public function recuperaPGQ() {
        ...
        if (!empty($Dados)) {
            foreach ($Dados as $lista) {
                ...
                //$arquivo = "<a href='javascript:void(0);' onclick=\"anexoPgq('{$lista->nome_arquivo}')\">" . $nomeArquivo . "</a>";
