...
class EnsaioConstrucao extends CI_Controller
{
	...
	public function recuperaEnsaiosLaboratorio()
	{
		...
		if (!empty($Dados)) {
			foreach ($Dados as $i => $lista) {
				...
				//$arquivo = "<a href='javascript:void(0);' onclick=\"anexoEnsaio('{$lista->nome_arquivo}')\">" . $nomeArquivo . "</a>";
