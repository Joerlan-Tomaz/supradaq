...
//----------------------------------------------------------------------------------------------------
	public function insereRnc()
	{
		...
		$dados["natureza"] = $this->input->post_get('natureza');
	...
	public function RecuperaFotos()
	{
		...
		if (!empty($DadosFotos)) {
			...
			foreach ($DadosFotos as $lista) {
				...
				//$foto = "<div> <a href='/index_cgob.php/70bc1de8a077e52493d9c41ffaa3c051?img=" . $lista->nome_arquivo . "' data-fancybox='group'> <img src='/index_cgob.php/70bc1de8a077e52493d9c41ffaa3c051?img=" . $lista->nome_arquivo . "' alt='img01' width='45%' height='90px'></a> <div> <small>Clique na foto para ampliar!</small></div></div>";
                                    $imagem = "<div>";
                                    $imagem .= "    <a href='index_cgob.php/70bc1de8a077e52493d9c41ffaa3c051?img=" . $lista->nome_arquivo . "' data-fancybox='group'>";
                                    $imagem .= "        <img src='index_cgob.php/70bc1de8a077e52493d9c41ffaa3c051?img=" . $lista->nome_arquivo . "' alt='img01' width='45%' height='90px'>";
                                    $imagem .= "    </a>";
                                    $imagem .= "    <div>";
	...
	public function insereFoto()
	{
		...
		if (isset($_FILES["arquivo"])) {
			...
			for ($i = 0; $i < $x; $i++) {
				...
				$dados["id_upload"] = $this->session->idContrato . "_" . mt_rand() . "_" . $this->session->id_usuario_daq . "_4";
				$dados["periodo"] = $this->input->post_get("periodo");
