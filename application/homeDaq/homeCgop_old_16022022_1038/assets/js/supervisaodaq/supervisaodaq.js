...
function passaId(id) {
	$.ajax({
		url: base_url + 'index_cgop.php/ContratoSessionDaq',
		type: 'POST',
		data: {idContrato: id},
...
function rotaHomeObra() {
	$("#exibesupervisaocont").load(base_url + "index_cgop.php/ContratoInfoDaq").slideUp(3).delay(3).fadeIn("slow");
}

// //--------------------------------------------------------------------------------------------------------------------------------------
function rotaSupervisaoDaq() {
	$("#exibe").empty();
	$("#exibe").load(base_url + "index_cgop.php/HomeSupervisaoDaq").slideUp(3).delay(3).fadeIn("slow");      
}

function rotaRelatorioSupervisaoDaq() {
	$("#exibe").empty();
	$("#exibe").load(base_url + "index_cgop.php/HomeRelatorioDaq").slideUp(3).delay(3).fadeIn("slow");
}

function rotaDocumentacaoDaq() {
	$("#exibe").empty();
	$("#exibe").load(base_url + "index_cgop.php/HomeDocumentacaoDaq").slideUp(3).delay(3).fadeIn("slow");
}

function rotahomePainelAdm() {
	$("#exibe").empty();
	$("#exibe").load(base_url + "index_cgop.php/HomePainelDaq").slideUp(3).delay(3).fadeIn("slow");
}

function rotahomePainelGerencial() {
	$("#exibe").empty();
	$("#exibe").load(base_url + "index_cgop.php/homePainelGerencial").slideUp(3).delay(3).fadeIn("slow");
}
...
function confereRelatorio() {
	...
	var retorno = "";
	$.ajax({
		url: base_url + 'index_cgop.php/ConfereRelatorioDaq',
		type: 'POST',
		data: {periodo: termo},
		async: false,
		success: function (data) {
...
function rotaDaq() {
	$("#exibe").empty();
	$("#exibe").load(base_url + "index_cgop.php/HomeDaq").slideUp(3).delay(3).fadeIn("slow");
}
...
function Recuperatabelacontratos() {
	$("#exibesupervisaocont").load(base_url + "index_cgop.php/ContratoDaq").slideUp(3).delay(3).fadeIn("slow");
}
...
function search() {
	...
	if (tamanho >= 3) {
		...
		$('#contrato_supervisao').dataTable({
			...
			"sAjaxSource": base_url + "index_cgop.php/ContratoRecuperaDaq?contrato=" + contrato,
			"fnServerParams":
				function (aoData) {
