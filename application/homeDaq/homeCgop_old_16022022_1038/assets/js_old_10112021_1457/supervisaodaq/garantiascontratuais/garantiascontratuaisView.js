...
$().ready(function () {
    ...
    $("#insereGarantiaContratual").click(function () {
        ...
        bootbox.confirm("Confirmar operação [INSERIR GARANTIA CONTRATUAL]?", function (result) {
            if (result === true) {
                ...
                $.ajax({
                    url: base_url + 'index_cgop.php/GarantiaSeguroInsereDaq',
                    type: "POST",
                    data: serializedData,
                    dataType: 'json',
                    success: function (data) {
    ...
    $("#insereProvidencia").click(function () {
        ...
        bootbox.confirm("Confirmar operação [INSERIR PROVIDÊNCIA]?", function (result) {
            if (result === true) {
                $.ajax({
                    type: 'POST',
                    url: base_url + 'index_cgop.php/GarantiaSeguroInsereProvDaq',
    ...
    function anexoGaratias(nome_arquivo) {
        $.ajax({
            url: base_url + 'index_cgop.php/anexoGaratias',
            type: 'POST',
    ...
    $("#fileUpload").change(function () {
        bootbox.confirm("Confirmar operação [INSERIR ANEXO]?", function (result) {
            if (result === true) {
                ...
                $.ajax({
                    url: base_url + "index_cgop.php/GarantiaSeguroInsereAnxDaq",
                    type: "POST",
                    data: form,
                    dataType: "json",
                    contentType: false,
...
function excluirGarantias(nome_arquivo) {
    $.ajax({
        url: base_url + 'index_cgop.php/excluirGarantias',
        type: 'POST',
        data: {nome_arquivo: nome_arquivo},
        success: function (data) {
...
function populaTipoGarantia() {
    $.ajax({
        type: "POST",
        url: base_url + "index_cgop.php/GarantiaSeguroTipoDaq",
        dataType: "json",
        success: function (data) {
...
function recuperaGarantiaSeguro() {
    ...
    $('#tableGarantiaContratual').dataTable({
        ...
        "sAjaxSource": base_url + "index_cgop.php/GarantiaSeguroRecuperaDaq",
...
function recuperaObservacaoObjeto(id_garantia_seguro) {
    ...
    $.ajax({
        type: 'POST',
        url: base_url + 'index_cgop.php/GarantiaSeguroObsObjDaq',
        dataType: 'json',
    ...
    if (relatorio == 1) {
        ...
        bootbox.confirm("Confirmar operação [EXCLUIR REGISTRO]?", function (result) {
            if (result === true) {
                $.ajax({
                    type: 'POST',
                    url: base_url + 'index_cgop.php/GarantiaSeguroExcluirDaq',
                    data: {id_garantia_seguro: id_garantia_seguro},
                    dataType: 'json',
                    success: function (data) {
                        $.notify('Excluido com sucesso!', "success");
...
function modalSituacao(id_garantia_seguro, st) {
    ...
    if (st == "Fechado") {
        ...
        $('#tableProvidenciaGarantiaSeguro').dataTable({
            ...
            "sAjaxSource": base_url + "index_cgop.php/GarantiaSeguroRecuperaProvDaq",
            "fnServerParams": function (aoData) {
                 aoData.push(
    ...
    if (relatorio == 1) {
        ...
        bootbox.confirm("Confirmar operação [EXCLUIR REGISTRO]?", function (result) {
            if (result === true) {
                $.ajax({
                    type: "POST",
                    url: base_url + 'index_cgop.php/GarantiaSeguroExcluiProvDaq',
...
function modalAnexo(id_garantia_seguro) {
    ...
    if (relatorio == 1) {
        ...
        $("#tableAnexoGarantiaSeguro").dataTable({
            ...
            "sAjaxSource": base_url + "index_cgop.php/GarantiaSeguroRecuperaAnxDaq",
            "fnServerParams": function (aoData) {
    ...
    if (relatorio == 1) {
        ...
        bootbox.confirm("Confirmar operação [EXCLUIR ANEXO]?", function (result) {
            if (result === true) {
                $.ajax({
                    type: "POST",
                    url: base_url + "index_cgop.php/GarantiaSeguroExluiAnxDaq",
