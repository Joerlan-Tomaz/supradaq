	...
	$("#insereInterferencia").click(function () {
		...
		bootbox.confirm("Confirmar operação [INSERIR RISCO]?", function (result) {
			if (result === true) {
				$.ajax({
					type: 'POST',
					url: base_url + 'index_cgop.php/InterferenciaInsereDaq',
					data: serializedData,
					dataType: 'json',
	...
	$("#editarInterferencia").click(function () {
		...
		bootbox.confirm("Confirmar operação [EDIÇÃO]?", function (result) {
			if (result === true) {
				$.ajax({
					type: 'POST',
					url: base_url + 'index_cgop.php/InterferenciaEditarDaq?id=' + id,
					data: serializedData,
					dataType: 'json',
					success: function (data) {
						$.notify('Cadastrado com sucesso!', "success");
...
function recupera_TipoInterferencia() {
	$.ajax({
		type: 'POST',
		url: base_url + 'index_cgop.php/InterferenciaTipoDaq',
		dataType: 'json',
		success: function (data) {
...
function recupera_Classificacao() {
	$.ajax({
		type: 'POST',
		url: base_url + 'index_cgop.php/InterferenciaTipoClassDaq',
		dataType: 'json',
		success: function (data) {
...
function recupera_GrauImpacto() {
	$.ajax({
		type: 'POST',
		url: base_url + 'index_cgop.php/InterferenciaTipoGrauDaq',
		dataType: 'json',
		success: function (data) {
...
function populaTipoEixoEditar() {
	$.ajax({
		type: 'POST',
		url: base_url + 'index_cgop.php/InterferenciaTipoEixoDaq',
		dataType: 'json',
		success: function (data) {
...
function table_naohouveatividademes() {
	...
	$.ajax({
		type: 'POST',
		url: base_url + 'index_cgop.php/InterferenciaRecuperaAtvDaq?periodo=' + termo,
		data: {periodo: termo},
		dataType: 'json',
		success: function (data) {
			if (data.risco == true) {
				...
				$('#tableNaohouveAtividadeMes').dataTable({
					...
					"sAjaxSource": base_url + "index_cgop.php/InterferenciaRecuperaAtvDaq?periodo=" + termo,
					"aoColumns": [
						{data: 'atividademes'},
						{data: 'usuario'},
...
function recuperaInterferencias() {
	...
	$('#tableInterferencia').dataTable({
		...
		"sAjaxSource": base_url + "index_cgop.php/InterferenciaRecuperaDaq",
	...
	if (relatorio == 1) {
		...
		bootbox.confirm("Confirmar operação [EXCLUIR RISCO E INTERFERÊNCIA]?", function (result) {
			if (result === true) {
				$.ajax({
					type: 'POST',
					url: base_url + 'index_cgop.php/InterferenciaExcluirDaq',
...
function descricaoInterferencia(id_riscos_interferencias) {
	...
	$.ajax({
		type: 'POST',
		url: base_url + 'index_cgop.php/InterferenciaDescricaoDaq',
		dataType: 'json',
		data: {id_riscos_interferencias: id_riscos_interferencias},
		success: function (data) {
...
function recuperaInterferenciaEditar(id_riscos_interferencias, linha) {
	...
	bootbox.confirm("Confirmar operação [EDITAR]?", function (result) {
		if (result === true) {
			...
			$.ajax({
				type: "POST",
				url: base_url + "index_cgop.php/InterferenciaRecuperaEditarDaq",
				data: {id_riscos_interferencias: id_riscos_interferencias},
				dataType: "json",
				success: function (data) {
	...
	if (relatorio == 1) {
		...
		bootbox.confirm("Confirmar operação [NÃO HOUVE ATIVIDADE NO MÊS]?", function (result) {
			if (result === true) {
				$.ajax({
					type: 'POST',
					url: base_url + 'index_cgop.php/InterferenciaInsereAtvDaq',
					data: {
						periodo: termo
					},
					dataType: 'json',
	...
	if (relatorio == 1) {
		...
		bootbox.confirm("Confirmar operação [EXCLUIR]?", function (result) {
			if (result === true) {
				$.ajax({
					type: 'POST',
					url: base_url + 'index_cgop.php/InterferenciaAtvDaq?id=' + id,
					dataType: 'json',
					success: function (data) {
