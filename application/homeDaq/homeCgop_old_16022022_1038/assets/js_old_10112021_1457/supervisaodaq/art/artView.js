	...
	$("#insereConfigART").click(function () {
		...
		bootbox.confirm("Confirmar operação [INSERIR ART]?", function (result) {
			if (result === true) {
				$.ajax({
					type: "POST",
					url: base_url + "index_cgop.php/insereARTdaq",
					data: form,
					contentType: false,
					processData: false,
					dataType: "json",
...
function recuperaART() {
	...
	$("#tableART").dataTable({
		...
		"sAjaxSource": base_url + "index_cgop.php/recuperaARTDaq?periodo=" + termo,
	...
	if (relatorio == 1) {
		...
		bootbox.confirm("Confirmar operação [EXCLUIR ART]?", function (result) {
			if (result === true) {
				$.ajax({
					type: "POST",
					url: base_url + "index_cgop.php/excluirARTDaq",
...
function populaUF_art() {
	$.ajax({
		type: "POST",
		url: base_url + "index_cgop.php/populaUFDaq",
		dataType: "json",
		success: function (data) {
...
function RecuperaEditaART(id_art_supervisao, id_arquivo) {
	bootbox.confirm("Confirmar operação [EDITAR ART]?", function (result) {
		if (result === true) {
			...
			$.ajax({
				type: "POST",
				url: base_url + "index_cgop.php/ArtEditarDaq",
				data: {id_art_supervisao: id_art_supervisao, id_arquivo: id_arquivo},
				dataType: "json",
				success: function (data) {
...
function editarConfigART() {
	...
	bootbox.confirm("Confirmar operação [EDITAR ART]?", function (result) {
		if (result === true) {
			$.ajax({
				type: "POST",
				url: base_url + "index_cgop.php/EditarArtDaq?id_art_supervisao=" + id_art_supervisao,
				data: form,
				contentType: false,
				processData: false,
				dataType: "json",
