...
function insereCronogramaFisico(id_cronograma, versao, id_eixo) {
	...
	if (medicao == '%') {
		...
		//----------------------------------------------------------------------------------------------//
		// var Validar = Validar_Porcentagem(id_operacao, id_servico, versao, somafinal);
		// if (Validar != true) {
		// 	for (i = 1; i <= 12; i++) {
	...
	bootbox.confirm("Confirmar operação [INSERIR CRONOGRAMA FÍSICO]?", function (result) {
		if (result === true) {
			$.ajax({
				type: 'POST',
				url: base_url + 'index_cgop.php/CronogramaFisicoInsereDaq?id_eixo=' + id_eixo + '&id_cronograma=' + id_cronograma + '&versao=' + versao,
				data: serializedData,
				dataType: 'json',
				success: function (data) {
...
//--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
function Validar_Porcentagem(id_operacao, id_servico, versao, final) {
	$.ajax({
		type: 'POST',
		url: base_url + 'index_cgop.php/CronogramaFisicoVPorcentDaq',
		data: {
			id_operacao: id_operacao, id_servico: id_servico, versao: versao, final: final, tipo: $('#tipo').val()
		},
		dataType: 'json',
		async: false,
		success: function (data) {
...
function insereCronogramaFisicoNovo(id_eixo) {
	...
	bootbox.confirm("Confirmar operação [INSERIR CRONOGRAMA FÍSICO]?", function (result) {
		if (result === true) {
			$.ajax({
				type: 'POST',
				url: base_url + 'index_cgop.php/CronogramaFisicoInsereNovoDaq?id_eixo=' + id_eixo,
				data: serializedData,
				dataType: 'json',
				success: function (data) {
					$.notify('Cadastrado com sucesso!', "success");
...
function RecuperaEixo(id_eixo) {
	$.ajax({
		type: 'POST',
		url: base_url + 'index_cgop.php/CronogramaFisicoEixoDaq?id_eixo=' + id_eixo,
		dataType: 'json',
		success: function (data) {
...
function TotalServicoAquaviario(id_cronograma, versao, id_eixo) {
	...
	$.ajax({
		type: 'POST',
		url: base_url + 'index_cgop.php/CronogramaFisicoTotalDaq?id_cronograma=' + id_cronograma + '&versao=' + versao + '&id_eixo=' + id_eixo,
		dataType: 'json',
		success: function (data) {
...
function ServicosInseridosAquaviario(id_cronograma, versao, id_eixo) {
	...
	$('#table_itens_inseridos').dataTable({
		...
		"sAjaxSource": base_url + "index_cgop.php/CronogramaFisicoRetornaServicoDaq?id_cronograma=" + id_cronograma + '&versao=' + versao + '&id_eixo=' + id_eixo,
		"aoColumns": [
...
function DetalhadoNaoPublicado(id_cronograma, versao, id_eixo, linha, conte) {
	...
	$('#table_visualizar_cronogramafisico_eixo').dataTable({
		...
		"sAjaxSource": base_url + "index_cgop.php/CronogramaFisicoDetalhadoNPDaq?id_cronograma=" + id_cronograma + '&versao=' + versao + '&id_eixo=' + id_eixo,
		"aoColumns": [
			{data: 'conte', "sClass": "text-center"},
			{data: 'obra', "sClass": "text-center"},
			{data: 'servico', "sClass": "text-center"},
...
function DetalhadoPublicado(id_cronograma, versao, id_eixo, linha, conte) {
	...
	$('#table_visualizar_cronogramafisico_eixo').dataTable({
		...
		"sAjaxSource": base_url + "index_cgop.php/CronogramaFisicoDetalhadoDaq?id_cronograma=" + id_cronograma + '&versao=' + versao + '&id_eixo=' + id_eixo,
		"aoColumns": [
			{data: 'conte', "sClass": "text-center"},
			{data: 'obra', "sClass": "text-center"},
			{data: 'servico', "sClass": "text-center"},
...
function PublicarCronograma_naopublicado(id_cronograma, versao, id_eixo) {
	bootbox.confirm("Confirmar operação [PUBLICAR CRONOGRAMA]?", function (result) {
		if (result === true) {
			$.ajax({
				type: 'POST',
				url: base_url + 'index_cgop.php/CronogramaFisicoPublicarDaq?id_cronograma=' + id_cronograma + '&versao=' + versao + '&id_eixo=' + id_eixo,
				dataType: 'json',
				success: function (data) {
...
function RecuperaGeorreferenciamento(id_eixo) {
	$.ajax({
		type: 'POST',
		url: base_url + 'index_cgop.php/CronogramaFisicoGeoDaq?id_eixo=' + id_eixo,
		dataType: 'json',
		success: function (data) {
...
function ListaItensInseridos() {
	...
	$.ajax({
		type: 'POST',
		url: base_url + 'index_cgop.php/CronogramaFisicoRetornaItensDaq?servico=' + servico + '&tipo=' + tipo,
		dataType: 'json',
		success: function (data) {
			for (j = 1; j <= 12; j++) {
				$('#valor_medido'+j).val('');
