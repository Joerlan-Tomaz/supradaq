//######################################################################################################################################################################################################################## 
//# DNIT
//# apresentacaosupervisoraView.js
...
$().ready(function () {
    ...
    $.ajax({
        type: 'POST',
        url: base_url + 'index_cgop.php/RecuperaApresentacaoSupervisoraDaq?periodo='+termo,
        dataType: 'json',
        success: function (data) {
    
            $("span[id='as_contrato']").html(data.contrato);
            $("span[id='as_empresa']").html(data.empresa_supervisora);
            ...
            if (data.contrato != "") {
                var x = document.getElementById('exibeApresentacaoSupervisora');
                if (x.style.display === 'none') {
                    x.style.display = 'block';
                }
            } else {
                $.notify('Relacionar contrato de supervisão a obra no sistema!', "danger");
                $("#gravaApresentacao").prop("disabled", true);
            }
    ...
    $('#tableAsAditivo').dataTable({
        ...
        "sAjaxSource": base_url + "index_cgop.php/SupervisoraAditivoDaq",
        "aoColumns": [
    ...
    //Apresentação Supervisora table Fiscal-------------------------------------
    $('#tableAsFiscal').dataTable({
        ...
        "sAjaxSource": base_url + "index_cgop.php/SupervisoraFiscaisDaq?contrato_fiscalizado=Supervisão",
    ...
    //Apresentação Supervisora table Localizacao--------------------------------
    $('#tableAsLocalizacao').dataTable({
        ...
        "sAjaxSource": base_url + "index_cgop.php/SupervisoraLocalizacaoDaq",
        "aoColumns": [
            {data: 'HIDROVIA', "sClass": "text-center"},
            {data: 'INICIAL', "sClass": "text-center"},
            {data: 'FINAL', "sClass": "text-center"},
            {data: 'KM_INICIAL', "sClass": "text-center"},
            {data: 'KM_FINAL', "sClass": "text-center"},
     ...
     $("#tableAsResponsavelTecnico").dataTable({
        ...
        "sAjaxSource": base_url + "index_cgop.php/SupervisoraRespTecnicoDaq",
        "aoColumns": [
   ...
   $('#tableAsParalisacaoReinicio').dataTable({
        ...
        "sAjaxSource": base_url + "index_cgop.php/SupervisoraReinicioDaq?id_roteiro=19",
        "aoColumns": [
    ...
    $.ajax({
        ...
        dataType: 'json',
            ...
            success: function (data) {
                ...
                $("#empresa_supervisora").val(data.empresa_supervisora);
...
function gravaApresentacao() {
    ...
    bootbox.confirm("Confirmar operação [EDITAR APRESENTAÇÃO]?", function (result) {
        if (result === true) {
            $.ajax({
                type: 'POST',
                url: base_url + 'index_cgop.php/insereApresentacaosupervisoraDaq',
                data: serializedData,
                dataType: 'json',
                success: function (data) {
...
function gravaAditivo() {
    ...
    bootbox.confirm("Confirmar operação [INSERIR ADITIVO]?", function (result) {
        if (result === true) {
            $.ajax({
                type: 'POST',
                url: base_url + 'index_cgop.php/insereAditivosupervisoraDaq',
                data: serializedData,
                dataType: 'json',
                success: function (data) {
                    ...
                    // CKEDITOR.instances['objeto_termo'].setData("");
                    // CKEDITOR.instances['motivacao_aditivo'].setData("");
    ...
    if (relatorio == 1) {
        ...
        bootbox.confirm("Confirmar operação [EXCLUIR TERMO ADITIVO]?", function (result) {
            if (result === true) {
                $.ajax({
                    type: 'POST',
                    url: base_url + 'index_cgop.php/excluirAditivoSupervioraDaq',
...
function gravaLocalizacao() {
    ...
    bootbox.confirm("Confirmar operação [INSERIR LOCALIZAÇÃO]?", function (result) {
        if (result === true) {
            $.ajax({
                type: 'POST',
                url: base_url + 'index_cgop.php/insereLocalizacaoSupervisoraDaq',
                data: serializedData,
                dataType: 'json',
                success: function (data) {
                    $.notify('Cadastrado com sucesso!', "success");
    ...
    if (relatorio == 1) {
        ...
        bootbox.confirm("Confirmar operação [EXCLUIR LOCALIZAÇÃO]?", function (result) {
            if (result === true) {
                $.ajax({
                    type: 'POST',
                    url: base_url + 'index_cgop.php/excluirLocalizacaoSupervisoraDaq',
...
function gravaResponsavelTecnico() {
    ...
    bootbox.confirm("Confirmar operação [INSERIR RESPONSÁVEL TÉCNICO]?", function (result) {
        if (result === true) {
            $.ajax({
                type: 'POST',
                url: base_url + 'index_cgop.php/insereRespTecnicoSupDaq',
                data: serializedData,
                dataType: 'json',
                success: function (data) {
    ...
    if (relatorio == 1) {
        ...
        bootbox.confirm("Confirmar operação [EXCLUIR RESPONSÁVEL TÉCNICO]?", function (result) {
            if (result === true) {
                $.ajax({
                    type: 'POST',
                    url: base_url + 'index_cgop.php/excluirResptecnicoSupDaq',
...
function btgravaParalisacaoreinicio(){
        ...
        $.ajax({
            type: 'POST',
            url: base_url + 'index_cgop.php/insereReinicioSupervisaoDaq',
            data: form,
            dataType: 'json',
            contentType: false,
            processData: false,
...
//------------------------------------------------------------------------------
function excluirReinicio(nome_arquivo) {
    $.ajax({
        url: base_url + 'index_cgop.php/excluirReinicio',
        type: 'POST',
        data: {nome_arquivo: nome_arquivo},
        success: function (data) {
...
function excluirParalisacaoReinicio(id_paralisacaoreinicio,id_arquivo) {
    ...
    bootbox.confirm("Confirmar operação [EXCLUIR PARALISAÇÃO/REINICIO]?", function (result) {
        if (result === true) {
            $.ajax({
                type: 'POST',
                url: base_url + 'index_cgop.php/excluirReinicioSupDaq?id_paralisacaoreinicio='+id_paralisacaoreinicio+'&id_arquivo='+id_arquivo,
                dataType: 'json',
                success: function (data) {
                    $.notify('Excluido com sucesso!', "success");
                    var table = $("#tableAsParalisacaoReinicio").DataTable();
