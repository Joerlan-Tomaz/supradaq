    ...
    $("#insereAnexos").click(function () {
        ...
        bootbox.confirm("Confirmar operação [INSERIR ANEXO]?", function (result) {
            if (result === true) {
                $.ajax({
                    type: 'POST',
                    url: base_url + 'index_cgop.php/insereAnexoDaq',
                    data: form,
                    dataType: 'json',
                    contentType: false,
                    processData: false,
...
function recuperaAnexo() {
    ...
    $('#tableAnexos').dataTable({
        ...
        "sAjaxSource": base_url + "index_cgop.php/RecuperaAnexosDaq",
    ...
    if (relatorio == 1) {
        ...
        bootbox.confirm("Confirmar operação [EXCLUIR REGISTRO]?", function (result) {
            if (result === true) {
                $.ajax({
                    type: 'POST',
                    url: base_url + 'index_cgop.php/excluirArquivoDaq',
...
function checkCabecalho(termo) {
    $.ajax({
        type: 'POST',
        url: base_url + 'index_cgop.php/RecuperaAnexosDaq',
        data: {periodo: termo},
        dataType: 'json',
        success: function (data) {
