   ...
   $("#insereIntroducao").click(function () {
       ...
       bootbox.confirm("Confirmar operação [INSERIR INTRODUÇÃO]?", function (result) {
           if (result == true) {
               $.ajax({
                   type: 'POST',
                   url: base_url + 'index_cgop.php/IntroducaoInsereDaq',
                   data: serializedData,
                   dataType: 'json',
...
function recuperaHistorico() {
  //-----------------------------------------------------------
    ...
    $('#tabelaIntroducao').dataTable({
        ...
        "sAjaxSource": base_url + "index_cgop.php/IntroducaoRecuperaDaq?periodo="+termo,
        "aoColumns": [
...
function editarResumo(id_resumo) {
    ...
    $.ajax({
        type: 'POST',
        url: base_url + 'index_cgop.php/IntroducaoEditarDaq',
...
function excluirHistorico(id_resumo) {
    ...
    bootbox.confirm("Confirmar operação [EXCLUIR INTRODUÇÃO]?", function (result) {
        if (result === true) {
            $.ajax({
                type: 'POST',
                url: base_url + 'index_cgop.php/IntroducaoExcluirDaq',
                data: {id_resumo: id_resumo},
                dataType: 'json',
                success: function (data) {
