...
function RecuperaObra() {
	...
	$.ajax({
		type: 'POST',
		url: base_url + 'index_cgop.php/CronogramaFisicoObraDaq',
		dataType: 'json',
...
function RecuperaSevico(id_obra) {
	...
	if (id_obra !== "") {
		...
		$.ajax({
			type: 'POST',
			url: base_url + 'index_cgop.php/CronogramaFisicoServicoDaq',
...
function tipo(servico) {
	...
	$.ajax({
		type: 'POST',
		url: base_url + 'index_cgop.php/CronogramaFisicoTipoDaq',
