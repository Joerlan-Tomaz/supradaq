    ...
    $("#insereEnsaioLaboratorio").click(function () {
        ...
        bootbox.confirm("Confirmar operação [INSERIR ENSAIOS DE LABORATÓRIOS]?", function (result) {
            if (result === true) {
                $.ajax({
                    type: 'POST',
                    url: base_url + 'index_cgop.php/EnsaioSupInsereDaq',
                    data: form,
                    dataType: 'json',
                    contentType: false,
                    processData: false,
        ...
        // } else {
            ...
            bootbox.confirm("Confirmar operação [NÃO HOUVE ATIVIDADES ESTE MÊS]?", function (result) {
                if (result === true) {
                    $.ajax({
                        type: 'POST',
                        url: base_url + 'index_cgop.php/EnsaioSupInsereNHADaq',
                        data: {periodo: termo},
                        dataType: 'json',
                        success: function (data) {
                            $.notify(data.mensagem, data.notify);
...
function anexoEnsaiosup(nome_arquivo) {
    $.ajax({
        url: base_url + 'index_cgop.php/anexoEnsaiosup',
        type: 'POST',
...
function recuperaEnsaios() {
   ...
   ;
    $('#tableEnsaioLaboratorio').dataTable({
        ...
        "sAjaxSource": base_url + "index_cgop.php/EnsaioSupRecuperaDaq",
    ...
    if (relatorio == 1) {
        ...
        bootbox.confirm("Confirmar operação [EXCLUIR REGISTRO]?", function (result) {
            if (result === true) {
                $.ajax({
                    type: 'POST',
                    url: base_url + 'index_cgop.php/EnsaioSupExcluirDaq',
...
function excluirEnsaioSup(nome_arquivo) {
    $.ajax({
        url: base_url + 'index_cgop.php/excluirEnsaioSup',
        type: 'POST',
        data: {nome_arquivo: nome_arquivo},
        success: function (data) {
