...
//--------------------------------------------------------------------------------------------
    ...
    public function insereGeorreferenciamento() {
        ...
        $dadosComplemento["id_usuario"] = $this->session->id_usuario_daq;
   ...
   public function inserirdados(){
    $dadosS["id_arquivo"] = $this->input->post_get("idArquivo");
        ...
        //-------------------------------------------------------------------------------------
        if(array_key_exists(6,$h)===false){
            $result["mensagem"] = "Arquivo fora do Modelo!";
            $result["notify"] = "warning";
            die(json_encode($result)); 
        }
        //-------------------------------------------------------------------------------------
        $a = 'KM '; $b = 'ESTACA'; $c = 'X'; $d = 'Y'; $e = 'FUSO UTM';
        $f = 'HEMISFÉRIO (N/S)'; 
        //-------------------------------------------------------------------------------------
        ...
        if ($verificaArray == 5)
            continue;  
               $dados[]=array(
                        ...
                        'km'=>str_replace (',','.',$val ['1']),
                        'estaca'=>str_replace (',','.',$val ['2']),
                        'coordenada_norte'=> str_replace (',','.',$val ['3']),
                        'coordenada_leste'=> str_replace (',','.',$val ['4']),
                        'fuso'=> str_replace (',','.',$val ['5']),
                        'hemisferio'=> $val ['6'],
