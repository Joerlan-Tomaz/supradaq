...
//---------------------------------------------------------------------------------------
    public function insereLocalizacao($dados) {
          ...
          $this->db->set("id_roteiro", $dados["roteiro"]);
	        ...
	        $this->db->insert("CGOB_TB_APRESENTACAO_SUPERVISORA_LOCALIZACAO");
	 ...
	 public function Tablelocalizacao($dados) {
        $SQL = "
          SELECT
            ...
            FROM CGOB_TB_APRESENTACAO_SUPERVISORA_LOCALIZACAO AS l
    ...
    public function excluirLocalizacao($dados) {
        ...
        $this->db->update("CGOB_TB_APRESENTACAO_SUPERVISORA_LOCALIZACAO");
        return true;
    }
