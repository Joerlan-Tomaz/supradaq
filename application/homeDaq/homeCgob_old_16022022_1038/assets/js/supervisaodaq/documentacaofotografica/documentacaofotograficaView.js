...
$().ready(function () {
    ...
    $("#insereDocFotografico").click(function () { 
        ...
        if ($("#utmn_foto0").length){ 
            ...
            if(utmn_foto0 < (-100)){
               $.notify('O campo [Latitude] deve ser entre [-100 e 100]', "warning");  document.getElementById("utmn_foto0").style.borderColor = 'red'; return false;  
            }else{
        ...
        if ($("#utmn_foto1").length){ 
            ...
            if(utmn_foto1 < (-100)){
               $.notify('O campo [Latitude] deve ser entre [-100 e 100]', "warning");  document.getElementById("utmn_foto1").style.borderColor = 'red'; return false;  
            }else{
        ...
        if ($("#utmn_foto2").length){
            ...
            if(utmn_foto2 < (-100)){
               $.notify('O campo [Latitude] deve ser entre [-100 e 100]', "warning");  document.getElementById("utmn_foto2").style.borderColor = 'red'; return false;  
            }else{
        ...
        if ($("#utmn_foto3").length){
            ...
            if(utmn_foto3 < (-100)){
               $.notify('O campo [Latitude] deve ser entre [-100 e 100]', "warning");  document.getElementById("utmn_foto3").style.borderColor = 'red'; return false;  
            }else{
        ...
        if ($("#utme_foto0").length){
            ...
            if(utme_foto0 < (-100)){
               $.notify('O campo [Longitude] deve ser entre [-100 e 100]', "warning");  document.getElementById("utme_foto0").style.borderColor = 'red'; return false;  
            }else{
        ...
        if ($("#utme_foto1").length){
            ...
            if(utme_foto1 < (-100)){
               $.notify('O campo [Longitude] deve ser entre [-100 e 100]', "warning");  document.getElementById("utme_foto1").style.borderColor = 'red'; return false;  
            }else{
        ...
        if ($("#utme_foto2").length){
            ...
            if(utme_foto2 < (-100)){
               $.notify('O campo [Longitude] deve ser entre [-100 e 100]', "warning");  document.getElementById("utme_foto2").style.borderColor = 'red'; return false;  
            }else{
        ...
        if ($("#utme_foto3").length){
            ...
            if(utme_foto3 < (-100)){
               $.notify('O campo [Longitude] deve ser entre [-100 e 100]', "warning");  document.getElementById("utme_foto3").style.borderColor = 'red'; return false;  
            }else{
         ...
         //------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
          ...
          bootbox.confirm("Confirmar operação [INSERIR DOCUMENTAÇÃO FOTOGRÁFICA]?", function (result) {
            if (result === true) {
                $.ajax({
                    type: 'POST',
                    url: base_url + 'index_cgob.php/DocFotograficoInsereDaq',
                    data: form,
                    dataType: 'json',
                    contentType: false,
                    processData: false,
    ...
    $("#insereDocFotografico_old").click(function () {
          ...
          //---------------------------------------------------------------------
             ...
             alert(utmn_foto0);
            if(utmn_foto0 < (-100)){
              $.notify('O campo [Latitudeooo] deve ser entre [-100 e 100]', "warning");  document.getElementById("utmn_foto0").style.borderColor = 'red'; return false;  
            }else{
            ...
            if (tamanhoPost < maxSize) {
                ...
                for (i = 0; i < x.length; i++) {
                    if (x[i].type === "image/jpeg") {
                        ...
                        cols += "                <input id='estaca_foto" + i + "' name='estaca_foto" + i + "' maxlength='10' class='form-control' type='text' data-toggle='tooltip' data-placement='top' title=' O campo [Estaca] deve possuir numero e texto. '>";
                        cols += "            </div>";
                        cols += "        </div>";
                        cols += "        <div class='col-md-12'>";
                        cols += "            <div class='form-group'>";
...
function recuperaDocFotografica() {
    ...
    $("#tableDocFotografico").dataTable({
        ...
        "sAjaxSource": base_url + "index_cgob.php/DocFotograficoRecuperaDaq",
...
function anexoDoc(nome_arquivo) {
    $.ajax({
        url: base_url + 'index_cgob.php/anexoDoc',
        type: 'POST',
    ...
    if (relatorio == 1) {
        ...
        bootbox.confirm("Confirmar operação [EXCLUIR DOCUMENTAÇÃO]?", function (result) {
            if (result === true) {
                $.ajax({
                    type: 'POST',
                    url: base_url + 'index_cgob.php/DocFotograficoExcluirDaq',
...
function excluirDoc(nome_arquivo) {
    $.ajax({
        url: base_url + 'index_cgob.php/excluirDoc',
        type: 'POST',
        data: {nome_arquivo: nome_arquivo},
        success: function (data) {
...
function editarDocumentacao(id_arquivo) {
    ...
    if (relatorio == 1) {
        ...
        $.ajax({
            type: "POST",
            url: base_url + "index_cgob.php/editarDocumentacaoDaq",
...
function alteraDocFotografico() {
    ...
    if(utmn_foto_edit < (-100)){
       $.notify('O campo [Latitude] deve ser entre [-100 e 100]', "warning");  document.getElementById("utmn_foto_edit").style.borderColor = 'red'; return false;  
    }else{
    ...
    if(utmn_foto_edit > 100){
     ...
     if(utme_foto_edit < (-100)){
       $.notify('O campo [Longitude] deve ser entre [-100 e 100]', "warning");  document.getElementById("utme_foto_edit").style.borderColor = 'red'; return false;  
     }else{
    ...
    bootbox.confirm("Confirmar operação [ALTERAR DOCUMENTAÇÃO FOTOGRÁFICA]?", function (result) {
        if (result === true) {
            $.ajax({
                type: "POST",
                url: base_url + "index_cgob.php/alteraDocumentacaoDaq",
                data: serializedData,
                dataType: "json",
                success: function (data) {
