	...
	$("#inserePortariaFiscal").click(function () {
		...
		bootbox.confirm("Confirmar operação [INSERIR PORTARIAS DE FISCAIS]?", function (result) {
			if (result === true) {
				$.ajax({
					type: "POST",
					url: base_url + "index_cgob.php/PortariasFiscaisInsereDaq",
					data: form,
					dataType: "json",
					contentType: false,
					processData: false,
...
function anexoPortarias(nome_arquivo) {
	$.ajax({
		url: base_url + 'index_cgob.php/anexoPortarias',
		type: 'POST',
...
function recuperaPortariasFiscais() {
	...
	$("#tablePortariaFiscal").dataTable({
		...
		"sAjaxSource": base_url + "index_cgob.php/PortariasFiscaisRecuperaDaq?periodo=" + termo,
	...
	if (relatorio == 1) {
		...
		bootbox.confirm("Confirmar operação [EXCLUIR PORTARIAS DE FISCAIS]?", function (result) {
			if (result === true) {
				$.ajax({
					type: "POST",
					url: base_url + "index_cgob.php/PortariasFiscaisExcluiDaq",
...
function populaUF() {
	$.ajax({
		type: 'POST',
		url: base_url + 'index_cgob.php/PortariasFiscaisUfDaq',
		dataType: 'json',
		success: function (data) {
...
function populaTitularidade() {
	$.ajax({
		type: 'POST',
		url: base_url + "index_cgob.php/PortariasFiscaisTitularidadeDaq",
		dataType: 'json',
		success: function (data) {
...
function excluirPortaria(nome_arquivo) {
	$.ajax({
		url: base_url + 'index_cgob.php/excluirPortaria',
		type: 'POST',
		data: {nome_arquivo: nome_arquivo},
		success: function (data) {
