     ...
     //----------------------------------------------------------------------
        ...
        bootbox.confirm("Confirmar operação [INSERIR GESTÃO DE TRATATIVAS]?", function (result) {
            if (result === true) {
                $.ajax({
                    type: "POST",
                    url: base_url + "index_cgob.php/GestaoTratativaInsereDaq",
                    data: serializedData,
                    dataType: "json",
        ...
        if (relatorio == 1) {
            ...
            bootbox.confirm("Confirmar operação [INSERIR PROVIDÊNCIA]?", function (result) {
                if (result === true) {
                    $.ajax({
                        type: "POST",
                        url: base_url + "index_cgob.php/GestaoTratativaInsereProvDaq",
                        data: {
...
function btnNoAtividade() {
    ...
    bootbox.confirm("Confirmar operação [NÃO HOUVE ATIVIDADE NO MÊS]?", function (result) {
        if (result === true) {
            $.ajax({
                type: 'POST',
                url: base_url + 'index_cgob.php/GestaoTratativaInsereAtividadeDaq',
                data: {
                    periodo: termo
                },
                dataType: 'json',
...
if (document.getElementById) {
    ...
    bootbox.confirm("Confirmar operação [EDITAR GESTÂO]?", function (result) {
        if (result === true) {
            $.ajax({
                type: 'POST',
                url: base_url + 'index_cgob.php/GestaoTratativaReturnEditarDaq',
...
//------------------ Verificação de campos -----------------------------
        ...
        bootbox.confirm("Confirmar operação [INSERIR GESTÃO]?", function (result) {
            if (result === true) {
                $.ajax({
                    type: "POST",
                    url: base_url + "index_cgob.php/GestaoTratativaEditarDaq",
                    data: form,
                    dataType: "json",
                    cache: false,
                    contentType: false,
...
function table_naohouveatividademes() { 
    ...
    $.ajax({
        type: 'POST',
        url: base_url + 'index_cgob.php/GestaoTratativaNaoAtividadeDaq?periodo='+termo,
        data: {periodo: termo},
        dataType: 'json',
        success: function (data) {
            if (data.atividade == true) {
                ...
                $('#tableNaohouveAtividadeMes').dataTable({
                    ...
                    "sAjaxSource": base_url + "index_cgob.php/GestaoTratativaNaoAtividadeDaq?periodo="+termo,
                    "aoColumns": [
                        {data: 'atividademes'},
                        {data: 'usuario'},
...
function recuperaGestaoTratativa() {
    ...
    $("#tableGestaoTratativa").dataTable({
        ...
        "sAjaxSource": base_url + "index_cgob.php/GestaoTratativaRecuperaDaq",
    ...
    if (relatorio == 1) {
        ...
        bootbox.confirm("Confirmar operação [EXCLUIR REGISTRO]?", function (result) {
            if (result === true) {
                $.ajax({
                    type: "POST",
                    url: base_url + "index_cgob.php/GestaoTratativaExcluirDaq",
...
function populaOrigem() {
    $.ajax({
        type: "POST",
        url: base_url + "index_cgob.php/GestaoTratativaOriginDaq",
        dataType: "json",
        success: function (data) {
...
function populaResponsaveis() {
    $.ajax({
        type: "POST",
        url: base_url + "index_cgob.php/GestaoTratativaRespDaq",
        dataType: "json",
        success: function (data) {
...
function modalStatus(id_gestao_tratativa) {
    ...
    $.ajax({
        type: "POST",
        url: base_url + "index_cgob.php/GestaoTratativaModalDaq",
        data: {id_gestao_tratativa: id_gestao_tratativa},
        dataType: "json",
        success: function (data) {
...
function modalSituacao(id_gestao_tratativa, st) {
    ...
    $('#tableProvidenciaGestaotratativa').dataTable({
        ...
        "sAjaxSource": base_url + "index_cgob.php/GestaoTratativaRecuperaProvDaq",
        "fnServerParams": function (aoData) {
             aoData.push(
    ...
    if (relatorio == 1) {
        ...
        bootbox.confirm("Confirmar operação [EXCLUIR REGISTRO]?", function (result) {
            if (result === true) {
                $.ajax({
                    type: "POST",
                    url: base_url + "index_cgob.php/GestaoTratativaExcluirProvDaq",
...
function NaoHouveAtividadedaq(id) {
    bootbox.confirm("Confirmar operação [EXCLUIR]?", function (result) {
        if (result === true) {
            $.ajax({
                type: 'POST',
                url: base_url + 'index_cgob.php/GestaoTratativaNaoAtvDaq?id=' + id,
                dataType: 'json',
                success: function (data) {
