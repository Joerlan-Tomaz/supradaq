...
function Recupera_item_cadastro() {
    $.ajax({
        type: 'POST',
        url: base_url + 'index_cgob.php/SicroSupervisoraItemDaq',
        dataType: 'json',
...
function Recupera_relacao_item_cadastro() {
    ...
    $('#tablecadastraritem').dataTable({
        ...
        "sAjaxSource": base_url + "index_cgob.php/SicroSupervisoraRelacaoItemDaq?itemcadastro=" + itemcadastro +"&sicro="+sicro+"&tipo="+tipo,
    ...
    if (relatorio == 1) {
     ...
     if (document.getElementById) {
        ...
        var termo = dt.getFullYear() + "-" + ((dt.getMonth() + 1) > 9 ? (dt.getMonth() + 1) : "0" + (dt.getMonth() + 1)) + "-01";
           ...
           $.ajax({
                    type: 'POST',
                    url: base_url + 'index_cgob.php/SicroSupervisoraCadastraItemDaq?id_sicro='+id_sicro,
                    data: {
                    periodo: termo
                },
                    dataType: 'json',
