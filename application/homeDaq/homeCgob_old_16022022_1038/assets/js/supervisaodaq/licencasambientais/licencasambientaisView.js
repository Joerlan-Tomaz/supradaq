    ...
    $("#insereLicencaAmbiental").click(function () {
        ...
        bootbox.confirm("Confirmar operação [INSERIR LICENÇA AMBIENTAL]?", function (result) {
            if (result === true) {
                $.ajax({
                    type: "POST",
                    url: base_url + "index_cgob.php/LicencasAmbientaisInsereDaq",
                    data: form,
                    dataType: "json",
                    cache: false,
                    contentType: false,
        ...
        if (relatorio == 1) {
            ...
            bootbox.confirm("Confirmar operação [NÃO HOUVE ATIVIDADES ESTE MÊS]?", function (result) {
                if (result === true) {
                    $.ajax({
                        type: "POST",
                        url: base_url + "index_cgob.php/insereNaoAtividadelsDaq",
                        data: {periodo: termo},
                        dataType: "json",
                        success: function (data) {
...
function excluirLicensas(nome_arquivo) {
    $.ajax({
        url: base_url + 'index_cgob.php/excluirLicensas',
        type: 'POST',
        data: {nome_arquivo: nome_arquivo},
        success: function (data) {
...
function recuperaLicencaAmbiental() {
    ...
    $("#tableLicencasAmbientais").dataTable({
        ...
        "sAjaxSource": base_url + "index_cgob.php/LicencasAmbientaisRecuperaDaq?periodo="+termo,
    ...
    // } else {
        bootbox.confirm("Confirmar operação [EXCLUIR REGISTRO]?", function (result) {
            if (result === true) {
                $.ajax({
                    type: "POST",
                    url: base_url + "index_cgob.php/LicencasAmbientaisExcluirDaq",
    ...
    // } else {
        ...
        bootbox.confirm("Confirmar operação [EDITAR LICENÇA]?", function (result) {
            if (result === true) {
                $.ajax({
                    type: "POST",
                    url: base_url + "index_cgob.php/LicencasAmbientaisRecEditarDaq",
...
//------------------ Verificação de campos -----------------------------
        ...
        bootbox.confirm("Confirmar operação [INSERIR LICENÇA AMBIENTAL]?", function (result) {
            if (result === true) {
                $.ajax({
                    type: "POST",
                    url: base_url + "index_cgob.php/LicencasAmbientaisEditarDaq",
                    data: form,
                    dataType: "json",
                    cache: false,
                    contentType: false,
...
function populaTipoLicenca() {
    $.ajax({
        type: 'POST',
        url: base_url + 'index_cgob.php/LicencasAmbientaisTipoDaq',
        dataType: 'json',
        success: function (data) {
