...
$().ready(function () {
    ...
    $.ajax({
        type: 'POST',
        url: base_url + 'index_cgob.php/RecuperaApresentacaoConstrutoraDaq?periodo='+termo,
        dataType: 'json',
    ...
    $('#tableAsAditivo').dataTable({
        ...
        "sAjaxSource": base_url + "index_cgob.php/RetornaAditivoDaq",
        "aoColumns": [
    ...
    $('#tableAsFiscal').dataTable({
        ...
        "sAjaxSource": base_url + "index_cgob.php/RetornaPortariasFiscaisDaq?contrato_fiscalizado=Obra",
    ...
    $('#tableAsLocalizacao').dataTable({
        ...
        "sAjaxSource": base_url + "index_cgob.php/RetornaLocalizacaoDaq",
        "aoColumns": [
    ...
    $('#tableAsResponsavelTecnico').dataTable({
        ...
        "sAjaxSource": base_url + "index_cgob.php/RetornaResponsaveltecnicoDaq",
        "aoColumns": [
    ...
    $('#tableAsParalisacaoReinicio').dataTable({
        ...
        "sAjaxSource": base_url + "index_cgob.php/RetornaParalisacaoReinicioDaq?id_roteiro=18",
        "aoColumns": [
	...
	$.ajax({
		url: base_url + 'index_cgob.php/RetornoSelectHidrovia',
		type: 'POST',
		dataType: 'json',
		data: {uf: this.value},
...
function gravaApresentacao() {
    ...
    bootbox.confirm("Confirma operação [EDITAR APRESENTAÇÃO]?", function (result) {
        if (result === true) {
            $.ajax({
                type: 'POST',
                url: base_url + 'index_cgob.php/insereApresentacaoconstrutoraDaq',
                data: serializedData,
                dataType: 'json',
                success: function (data) {
...
function gravaAditivo() {
    ...
    bootbox.confirm("Confirmar operação [INSERIR ADITIVO]?", function (result) {
        if (result === true) {
            $.ajax({
                type: 'POST',
                url: base_url + 'index_cgob.php/insereAditivoDaq',
                data: serializedData,
                dataType: 'json',
                success: function (data) {
    ...
    if (relatorio == 1) {
        ...
        bootbox.confirm("Confirmar operação [EXCLUIR TERMO ADITIVO]?", function (result) {
            if (result === true) {
                $.ajax({
                    type: 'POST',
                    url: base_url + 'index_cgob.php/excluirAditivoDaq',
...
function gravaLocalizacao() {
    ...
    bootbox.confirm("Confirmar operação [INSERIR LOCALIZAÇÃO]?", function (result) {
        if (result === true) {
            $.ajax({
                type: 'POST',
                url: base_url + 'index_cgob.php/insereLocalizacaoDaq',
                data: serializedData,
                dataType: 'json',
                success: function (data) {
    ...
    if (relatorio == 1) {
        ...
        bootbox.confirm("Confirmar operação [EXCLUIR LOCALIZAÇÃO]?", function (result) {
            if (result === true) {
                $.ajax({
                    type: 'POST',
                    url: base_url + 'index_cgob.php/excluirLocalizacaoDaq',
...
function gravaResponsavelTecnico() {
    ...
    bootbox.confirm("Confirmar operação [INSERIR RESPONSÁVEL TÉCNICO]?", function (result) {
        if (result === true) {
            $.ajax({
                type: 'POST',
                url: base_url + 'index_cgob.php/insereResponsavelTecnicoDaq',
                data: serializedData,
                dataType: 'json',
                success: function (data) {
    ...
    if (relatorio == 1) {
        ...
        bootbox.confirm("Confirmar operação [EXCLUIR RESPONSÁVEL TÉCNICO]?", function (result) {
            if (result === true) {
                $.ajax({
                    type: 'POST',
                    url: base_url + 'index_cgob.php/excluirResponsaveltecnicoDaq',
...
function btgravaParalisacaoreinicio(){
        ...
        $.ajax({
            type: 'POST',
            url: base_url + 'index_cgob.php/insereParalisacaoReinicioConstrucaoDaq',
            data: form,
            dataType: 'json',
            contentType: false,
            processData: false,
...
function excluirparalizacao(nome_arquivo) {
    $.ajax({
        url: base_url + 'index_cgob.php/excluirparalizacao',
        type: 'POST',
        data: {nome_arquivo: nome_arquivo},
        success: function (data) {
...
function excluirParalisacaoReinicio(id_paralisacaoreinicio,id_arquivo) {
    ...
    bootbox.confirm("Confirmar operação [EXCLUIR PARALISAÇÃO/REINICIO]?", function (result) {
        if (result === true) {
            $.ajax({
                type: 'POST',
                url: base_url + 'index_cgob.php/excluirParalisacaoReinicioDaq?id_paralisacaoreinicio='+id_paralisacaoreinicio+'&id_arquivo='+id_arquivo,
                dataType: 'json',
                success: function (data) {
                    $.notify('Excluido com sucesso!', "success");
                    var table = $("#tableAsParalisacaoReinicio").DataTable();
