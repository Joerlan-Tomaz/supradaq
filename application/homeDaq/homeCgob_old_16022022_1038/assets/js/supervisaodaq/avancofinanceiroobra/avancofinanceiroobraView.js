...
function RecuperaMedicao() { 
    ...
    table_naopublicado.destroy();
     ...
     $('#table_visualizar_medicao_naopublicado').dataTable({
        ...
        "sAjaxSource": base_url + "index_cgob.php/AvancoFinNaoPublicadoDaq?periodo="+termo,
        "aoColumns": [
    ...
    table_publicado.destroy();
     ...
     $('#table_visualizar_medicao_publicado').dataTable({
        ...
        "sAjaxSource": base_url + "index_cgob.php/AvancoFinPublicadoDaq?periodo="+termo,
        "aoColumns": [
            {data: 'nume_medicao', "sClass": "text-center"},
            {data: 'mes_referencia', "sClass": "text-center"},
            {data: 'valor_medicao', "sClass": "text-center"},
...
function RecuperaMedicaoNumeMedicao(numemedicao) { 
    ...
    table.destroy();
     ...
     $('#table_visualizar_detalhar').dataTable({
        ...
        "sAjaxSource": base_url + "index_cgob.php/AvancoFinNumMedicaoDaq?periodo="+termo+"&numemedicao="+numemedicao,
        "aoColumns": [
...
function RecuperaDetalhadoNaopublicado(numemedicao,linha,conte){  
    ...
    //----------------------------------------------------------------------
        ...
        $('#table_visualizar_avanco').dataTable({
                ...
                "sAjaxSource": base_url + "index_cgob.php/AvancoFinDetalhadoDaq?excluir=1&periodo="+termo+"&numemedicao="+numemedicao,
                "aoColumns": [
                    {data: 'n', "sClass": "text-center"},
...
function RecuperaDetalhadoPublicado(numemedicao,linha,conte){  
    ...
    //----------------------------------------------------------------------
        ...
        $('#table_visualizar_avanco').dataTable({
                ...
                "sAjaxSource": base_url + "index_cgob.php/AvancoFinDetalhadoDaq?periodo="+termo+"&numemedicao="+numemedicao,
                "aoColumns": [
                    {data: 'n', "sClass": "text-center"},
                    {data: 'obra', "sClass": "text-center"},
                    {data: 'servico', "sClass": "text-center"},
...
function obra(){
    ...
    if (this.value !== "") {
     ...
     $.ajax({
        type: 'POST',
        url: base_url + 'index_cgob.php/AvancoFinObraDaq',
        dataType: 'json',
...
function servico(id_obra){
    ...
    if (id_obra !== "") {
     ...
     $.ajax({
        type: 'POST',
        url: base_url + 'index_cgob.php/AvancoFinServicoDaq',
...
function tipo(servico){
    var servico=$("#servico").val();
        $.ajax({
            type: 'POST',
            url: base_url + 'index_cgob.php/AvancoFinTipoDaq',
    ...
    if(true) {
        ...
        bootbox.confirm("Confirmar operação [INSERIR AVANÇO FINANCEIRO]?", function (result) {
            if (result === true) {
                $.ajax({
                    type: 'POST',
                    url: base_url + 'index_cgob.php/AvancoFinInsereDaq?periodo='+termo+'&numemedicao='+numemedicao,
                    data: serializedData,
                    dataType: 'json',
                    success: function (data) {
...
function ExcluirAvancoInterno(id) {
    ...
    bootbox.confirm("Confirmar operação [EXCLUIR AVANÇO]?", function (result) {
        if (result === true) {
            $.ajax({
                type: 'POST',
                url: base_url + 'index_cgob.php/AvancoFinExcluirDaq?id=' + id,
                dataType: 'json',
                success: function (data) {
...
function PublicarNaopublicado(numemedicao,linha,conte) {
    ...
    bootbox.confirm("Confirmar operação [Publicar]?", function (result) {
        if (result === true) {
            $.ajax({
                type: 'POST',
                url: base_url + 'index_cgob.php/AvancoFinPublicarDaq?numemedicao='+numemedicao+'&periodo='+termo,
                dataType: 'json',
                success: function (data) {
...
function itensInseridos(numemedicao){
        ...
        $('#table_visualizar_avanco').dataTable({
                ...
                "sAjaxSource": base_url + "index_cgob.php/AvancoFinDetalhadoDaq?excluir=2&periodo="+termo+"&numemedicao="+numemedicao,
                "aoColumns": [
                    {data: 'n', "sClass": "text-center"},
                    {data: 'obra', "sClass": "text-center"},
                    {data: 'servico', "sClass": "text-center"},
