    ...
    if (relatorio == 1) {
        ...
        bootbox.confirm("Confirmar operação [EXCLUIR]?", function (result) {
            if (result === true) {
                ...
                $.ajax({
                    type: 'POST',
                    url: base_url + 'index_cgob.php/MobilizacaoConstrutoraExcluiDaq',
                    data: {
                        id: id
                    },
                    dataType: 'json',
...
function searchdate() { 
    ...
    $('#tableRelacaoMobilizacao').dataTable({
        ...
        "sAjaxSource": base_url + "index_cgob.php/MobilizacaoConstrutoraRetornaDaq",
        "fnServerParams":
                function (aoData) {
                    aoData.push(
...
function insereRelacaoMobilizacao() {
    ...
    bootbox.confirm("Confirmar operação [INSERIR RELAÇÃO]?", function (result) {
        if (result === true) {
            ...
            $.ajax({
                type: 'POST',
                url: base_url + 'index_cgob.php/MobilizacaoConstrutoraGravaDaq',
                data: {
                    data: serializedData,
                    periodo: termo
                },
...
function Recupera_item() {
    $.ajax({
        type: 'POST',
        url: base_url + 'index_cgob.php/MobilizacaoConstrutoraItemDaq',
        dataType: 'json',
        success: function (data) {
...
//--------------------------------------------------------------------------------------------------------------------------
    ...
    $('#tableCadastroRelacaoMobilizacao').dataTable({
        ...
        "sAjaxSource": base_url + "index_cgob.php/MobilizacaoConstrutoraRelacaoDaq?item=" + item,
        "fnServerParams":
                function (aoData) {
                    aoData.push(
                            {"name": "periodo", "value": termo}
