...
function recuperaPontoPassagem() {
	...
	$("#tablePontoPassagem").dataTable({
		...
		"sAjaxSource": base_url + "index_cgob.php/PontoPassagemRecuperaDaq?periodo=" + termo,
	...
	if (relatorio == 1) {
		...
		bootbox.confirm("Confirmar operação [EXCLUIR REGISTROS DE PONTO DE PASSAGEM DO ARQUIVO  '" + arquivo + "']?", function (result) {
			if (result === true) {
				$.ajax({
					type: "POST",
					url: base_url + "index_cgob.php/PontoPassagemExcluiDaq",
...
function anexoPontoPass(nome_arquivo) {
	$.ajax({
		url: base_url + 'index_cgob.php/anexoPontoPass',
		type: 'POST',
...
function ModeloPontoPassagem(nome_arquivo) {
	$.ajax({
		url: base_url + 'index_cgob.php/ModeloPontoPassagem',
		type: 'POST',
		data: {nome_arquivo: nome_arquivo},
		success: function (data) {
...
function detalhesPontoPassagem(id_arquivo) {
	...
	$("#tableDetalhesPontoPassagem").dataTable({
		...
		"sAjaxSource": base_url + "index_cgob.php/PontoPassagemDetalhesDaq",
		"fnServerParams": function (aoData) {
...
function fileUploadConfigPontosPassagem() {
	...
	$.ajax({
		type: "POST",
		url: base_url + "index_cgob.php/PontoPassagemInsereDaq",
		dataType: "json",
		data: form,
		dataType: "json",
		contentType: false,
...
function excluirpp(nome_arquivo) {
	$.ajax({
		url: base_url + 'index_cgob.php/excluirpp',
		type: 'POST',
		data: {nome_arquivo: nome_arquivo},
		success: function (data) {
			//$.notify('Excluido com Sucesso!', "success");
...
function btnInsere() {
	...
	$.ajax({
		type: "POST",
		url: base_url + "index_cgob.php/PontoPassagemInsereDadosDaq?nomeArquivo=" + nomeArquivo + "&idArquivo=" + idArquivo,
		dataType: "json",
		data: form,
		dataType: "json",
		contentType: false,
