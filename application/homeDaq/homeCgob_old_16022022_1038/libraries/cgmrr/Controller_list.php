...
/***
 * File: (Codeigniterapp)/libraries/controller_list.php
 * 
 ...
 * print_r($this->controller_list->getControllers());
 * 
 * @author Peter Prins 
 */
class Controller_list {
     ...
     * @return array
     */
    public function getControllers($sub_dir='*') {
        
        // Get all controllers 
        $this->aControllers = null;
        $this->setControllers($sub_dir);
     ...
     */
    private function setControllers($sub_dir='*') {
        // Loop through the controller directory
        foreach(glob(APPPATH . 'controllers/'.$sub_dir) as $controller) {
