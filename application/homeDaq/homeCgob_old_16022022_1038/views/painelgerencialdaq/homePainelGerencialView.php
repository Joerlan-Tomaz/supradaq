<link rel="stylesheet" href="application/homeDaq/homeCgob/assets/css/painelgerencial.css">
<script src="<?php echo(base_url('application/homeDaq/homeCgob/assets/js/painelgerencial/painelgerencial.js')) ?>"
...
<div class="content-wrapper" style="margin-left: 0px; padding-top: 0px !important;" id="dadosContratos">
    ...
    <section class="content" style=" top: 10px; position: relative;">
                                                                        ...
                                                                        <div class="card-header"
                                                                            ...
                                                                            <h3 class="card-title">
                                                                                ...
                                                                                <div class="col-md-1 pull-right"
                                                                                     title="Cronograma Financeiro"><a
                                                                                            ...
                                                                                            onclick="PainelFinanceiro();"><img
                                                                                                src="<?php echo(base_url('application/homeDaq/assets/img/icones/item2.png'))?>"
                                                                                                alt=""
                                                                                                data-toggle="tooltip"
                                                                                ...
                                                                                <div class="col-md-1 pull-right"
                                                                                     title="Cronograma Físico"><a
                                                                                            ...
                                                                                            onclick="PainelFisico();"><img
                                                                                                src="<?php echo(base_url('application/homeDaq/assets/img/icones/item1.png'))?>"
                                                                                                alt=""
                                                                                                data-toggle="tooltip"
                                                                                ...
                                                                                <div class="col-md-1 pull-right"
                                                                                     title="Empenho"><a
                                                                                            href="javascript:void(0);"
                                                                                            onclick="PainelEmpenho();"><img
                                                                                                src="<?php echo(base_url('application/homeDaq/assets/img/icones/item3.png'))?>"
                                                                                                alt=""
                                                                                                data-toggle="tooltip"
                                                                                                title="Empenho/RAP"
                                                                                                data-placement="top"
                                                                                ...
                                                                                <div class="col-md-1 pull-right"><a
                                                                                            ...
                                                                                            onclick="PainelMedicao();"><img
                                                                                                src="<?php echo(base_url('application/homeDaq/assets/img/icones/item5.png'))?>"
                                                                                                alt=""
                                                                                                data-toggle="tooltip"
                                                                                                title="Medição"
                                                                                                data-placement="top"
                                                                                ...
                                                                                <div class="col-md-1 pull-right"><a
                                                                                            ...
                                                                                            onclick="PainelIDFin();"><img
                                                                                                src="<?php echo(base_url('application/homeDaq/assets/img/icones/item4.png'))?>"
                                                                                                alt=""
                                                                                                data-toggle="tooltip"
                                                                                                title="IDFIN"
                                                                                                data-placement="top"
																...
																<div class="card-body">
																	<div class="row" style="min-height: 220px;">
																		...
																		<div class="col-xs-1 col-sm-2 col-md-3 vcenter">
																			<div class="row vcenter" >
																				<div class="col-md-12">
																					<span class="info-box-icon circle-line nao_preenchido" data-toggle="tooltip" title="Conclusão" data-placement="top"><i class="fa fa-check"></i></span>
																				</div>
																				<div class="col-md-12">
                                                                    ...
                                                                    <div class="card card-default"
                                                                        ...
                                                                        <div class="card-header"
                                                                            ...
                                                                            <h3 class="card-title">
                                                                                ...
                                                                                <!--																								src="http://10.100.11.235/assets/img/icones/item3.png"-->
                                                                                <!--																								alt=""-->
                                                                                <!--																								data-toggle="tooltip"-->
                                                                                <!--																								title=""-->
                                                                                <!--																								data-placement="top"-->
                                                                                ...
                                                                                <!--																								src="http://10.100.11.235/assets/img/icones/item5.png"-->
                                                                                <!--																								alt=""-->
                                                                                <!--																								data-toggle="tooltip"-->
                                                                                <!--																								title=""-->
                                                                                <!--																								data-placement="top"-->
        ...
        <div class="modal fade" id="modalPainelIDFin" tabindex="-1" role="dialog" aria-labelledby="painel"
             aria-hidden="true">
        ...
        <div class="modal fade" id="modalPainelMedicao" tabindex="-1" role="dialog" aria-labelledby="painel"
             aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
