...
<script src="<?php echo(base_url('application/homeDaq/homeCgob/assets/js/administracao/solicitaoacesso/solicitacaoacessoView.js')) ?>" type="text/javascript"></script>
