...
<section>
	...
	<section id="capa" class="sheet padding-10mm">
		...
		<div class="row" style="letter-spacing: 3px; text-align: center;">
			...
			<div class="col-md-12" style="margin-top: 10%;">
				<h2><b>RELATÓRIO DE SUPERVISÃO DE OBRAS AQUAVIÁRIAS</b></h2>
			</div>
		</div>
		<br><br>
		<table style="width: 100%; border-spacing: 5px; border-collapse: separate; ">
			...
			<tr style="line-height: 50px;">
				<td class="font12print">Extensão/Área</td>
				<td class="font12print">:</td>
	...
	<section id="sumario" class="sheet padding-10mm">
		...
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
				<a href="#atividade_construtora" class="subItem">8.1 APRESENTAÇÃO DA CONSTRUTORA</a>
			</div>
		</div>
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
				<a href="#relacao_mobilizacao_construtora" class="subItem">8.2 RELAÇÃO DE MOBILIZAÇÃO DA CONSTRUTORA</a>
			</div>
		</div>
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
		...
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
				<a href="#resumo_avanco_fisico">12. RESUMO DE AVANÇO FÍSICO </a>
			</div>
		</div>
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
				<a href="#controle_pluviometrico_documentacao_fotografica">13. DOCUMENTAÇÃO FOTOGRÁFICA</a>
			</div>
		</div>
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
		...
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
				<a href="#gestao_qualidade">15. GESTÃO DA QUALIDADE </a>
			</div>
		</div>
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
				<a href="#ensaio_laboratorio_construtora" class="subItem">15.1 ENSAIOS DE LABORATÓRIO DA CONSTRUTORA</a>
			</div>
		</div>
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
				<a href="#ensaio_laboratorio_supervisora" class="subItem">15.2 ENSAIOS DE LABORATÓRIO DA SUPERVISORA</a>
			</div>
		</div>
		<!-- <div class="row">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
		...
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
				<a href="#gestao_rnc">16. REGISTROS DE NÃO CONFORMIDADES – RNC</a>
			</div>
		</div>
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
				<a href="#gestao_juridica_garantias_seguros">17. GESTÃO JURÍDICA, GARANTIAS E SEGUROS </a>
			</div>
		</div>
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
				<a href="#riscos_interferencias">18. GESTÃO DE RISCOS E INTERFERÊNCIAS </a>
			</div>
		</div>
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
				<a href="#atas_correspondencias">19. ATAS E CORRESPONDÊNCIAS </a>
			</div>
		</div>
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
				<a href="#gestao_tratativas">20. GESTÃO DE TRATATIVAS </a>
			</div>
		</div>
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
				<a href="#conclusao_comentarios">21. CONCLUSÃO E COMENTÁRIOS</a>
			</div>
		</div>
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
		...
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
				<a href="#anexo_rpfo" class="subItem">23.2 RPFO - Revisão de projetos em fase de obra</a>
			</div>
		</div>
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
		...
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
				<a href="#anexo_lab_construtora" class="subItem">23.6 ENSAIOS DE LABORATÓRIO DA CONSTRUTORA</a>
			</div>
		</div>
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
				<a href="#anexo_lab_supervisora" class="subItem">23.7 ENSAIOS DE LABORATÓRIO DA SUPERVISORA</a>
			</div>
		</div>
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
				<a href="#anexo_garantias" class="subItem">23.8 JURÍDICO, GARANTIAS E SEGUROS</a>
			</div>
		</div>
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
				<a href="#anexo_atas" class="subItem">23.9 ATAS E CORRESPONDÊNCIAS</a>
			</div>
		</div>
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
		...
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
				<a href="#anexo_diario" class="subItem">23.12 DIÁRIO DE OBRA</a>
			</div>
		</div>
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
			...
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 fullJustify">
				...
				<tr>
					...
					if (!empty($diagrama_ocorrencia_pp_nao_cadastrado)) {
						...
						$arquivoimg = 'index_cgob.php/70bc1de8a077e52493d9c41ffaa3c051?img=' . $diagrama_ocorrencia_pp;
						?>
...
####################################################################################-->
	...
	<section id="atividade_construtora" class="sheet padding-10mm">
		...
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 bold">
				<h3>
					<strong>8.1 APRESENTAÇÃO DA CONSTRUTORA</strong>
				</h3>
			</div>
		</div>
		<br>
	...
	<section id="relacao_mobilizacao_construtora" class="sheet padding-10mm">
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 bold">
				<h3>
					<strong>8.2 RELAÇÃO DE MOBILIZAÇÃO DA CONSTRUTORA</strong>
				</h3>
			</div>
		</div>
		<br>
...
//														}
			...
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 fullJustify table-responsive">
				<table class="tabela bordaCompleta" style=" width: 100%;">
					...
					<tr>
						...
						<td colspan="9">
							<div class="col-md-12 center">
								<h2><b>RELATÓRIO PLUVIOMÉTRICO</b></h2>
							</div>
						</td>
					</tr>
					<tr>
	...
	<section id="resumo_avanco_fisico" class="sheet padding-10mm">
		<div class="row" id="resumo_avanco_fisico">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 bold">
				<h3>
					<strong>12. RESUMO DE AVANÇO FÍSICO</strong>
				</h3>
			</div>
		</div>
		<br>
	...
	<section id="controle_pluviometrico_documentacao_fotografica" class="sheet padding-10mm">
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 bold">
				<h3>
					<strong>13. DOCUMENTAÇÃO FOTOGRÁFICA</strong>
				</h3>
			</div>
		</div>
		<div class="row">
	...
	<section id="gestao_qualidade" class="sheet padding-10mm">
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 bold">
				<h3>
					<strong>15. GESTÃO DA QUALIDADE</strong>
				</h3>
			</div>
		</div>
		<div class="row" id="ensaio_laboratorio_construtora">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 bold">
				<h3>
					<strong>15.1 ENSAIOS DE LABORATÓRIO DA CONSTRUTORA</strong>
				</h3>
			</div>
		</div>
		<div class="row">
		...
		<div class="row" id="ensaio_laboratorio_supervisora">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 bold">
				<h3>
					<strong>15.2 ENSAIOS DE LABORATÓRIO DA SUPERVISORA</strong>
				</h3>
			</div>
		</div>
		<div class="row">
		...
		<div class="row" id="gestao_rnc">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 bold">
				<h3>
					<strong>16. REGISTROS DE NÃO CONFORMIDADES – RNC</strong>
				</h3>
			</div>
		</div>
		<div class="table-responsive">
	...
	<section id="gestao_juridica_garantias_seguros" class="sheet padding-10mm">
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 bold">
				<h3>
					<strong>17. GESTÃO JURÍDICA, GARANTIAS E SEGUROS</strong>
				</h3>
			</div>
		</div>
		<div class="table-responsive">
	...
	<section id="riscos_interferencias" class="sheet padding-10mm">
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 bold">
				<h3>
					<strong>18. GESTÃO DE RISCOS E INTERFERÊNCIAS</strong>
				</h3>
			</div>
		</div>
		<div class="row">
	...
	<section id="atas_correspondencias" class="sheet padding-10mm">
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 bold">
				<h3>
					<strong>19. ATAS E CORRESPONDÊNCIAS</strong>
				</h3>
			</div>
		</div>
		<div class="table-responsive">
	...
	<section id="gestao_tratativas" class="sheet padding-10mm">
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 bold">
				<h3>
					<strong>20. GESTÃO DE TRATATIVAS</strong>
				</h3>
			</div>
		</div>
		<div class="table-responsive">
	...
	<section id="conclusao_comentarios" class="sheet padding-10mm">
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 bold">
				<h3>
					<strong>21. CONCLUSÃO E COMENTÁRIOS</strong>
				</h3>
			</div>
		</div>
		<div class="row">
	...
	<section id="anexos" class="sheet padding-10mm">
				...
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 fullJustify table-responsive">
					<table class="tabela bordaCompleta table80" style="width: 100%;">
						...
						if (empty($resumoprojetoAnexo)){ ?>
							<tr class="center">
								<div class="alert alert-danger" role="alert">[23.1 RESUMO DE PROJETO] não cadastrado!
								</div>
							</tr>
						<?php }else{ ?>
						<thead class="center fundoCinzaCabecalho">
		...
		<div id="resumo_avanco_fisico">
			<div class="row">
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 bold">
					<h3>
						<strong>23.2 RPFO - Revisão de projetos em fase de obra
						</strong>
					</h3>
				</div>
			</div>
				...
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 fullJustify table-responsive">
					<table class="tabela bordaCompleta table80" style="width: 100%;">
						...
						if (empty($rpfoprojetoAnexo)){ ?>
							<tr class="center">
								<div class="alert alert-danger" role="alert">[23.2 RPFO - Revisão de projetos em fase de
									obra] - Não houve atividade no mês
								</div>
							</tr>
						<?php }else{ ?>
						<thead class="center fundoCinzaCabecalho">
		...
		<div id="anexo_lab_construtora">
			<div class="row">
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 bold">
					<h3>
						<strong>23.6 ENSAIOS DE LABORATÓRIO DA CONSTRUTORA
						</strong>
					</h3>
				</div>
			</div>
		...
		<div id="anexo_lab_supervisora">
			<div class="row">
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 bold">
					<h3>
						<strong>23.7 ENSAIOS DE LABORATÓRIO DA SUPERVISORA
						</strong>
					</h3>
				</div>
			</div>
	...
	<section id="anexos_rnc" class="sheet padding-10mm">
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 bold">
				<h3>
					<strong>23.8 REGISTROS DE NÃO CONFORMIDADES – RNC</strong>
				</h3>
			</div>
		</div>
	...
	<section id="resumo_avanco_fisico" class="sheet padding-10mm">
		<div id="resumo_avanco_fisico">
			<div class="row">
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 bold">
					<h3>
						<strong>23.9 Jurídica,Garantias e Seguros
						</strong>
					</h3>
				</div>
			</div>
		...
		<div id="anexo_atas">
			<div class="row">
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 bold">
					<h3>
						<strong>23.10 ATAS E CORRESPONDÊNCIAS
						</strong>
					</h3>
				</div>
			</div>
