...
<link rel="stylesheet" href="<?php echo (base_url('application/homeDaq/homeCgob/assets/css/homeDaq/recibo/estilos.css')) ?>" />
<link rel="stylesheet" href="<?php echo (base_url('application/homeDaq/homeCgob/assets/css/homeDaq/recibo/bootstrap.min.css')) ?>" />
<link rel="stylesheet" href="<?php echo (base_url('application/homeDaq/homeCgob/assets/css/homeDaq/recibo/print.css')) ?>" />
<style>
        ...
        <section id="relatorio" class="sheet padding-10mm">
            ...
            <div class="row">
                ...
                <div class="col-xs-4 col-sm-4 col-md-4 center">
                     <img src="<?php echo (base_url('application/homeDaq/homeCgob/assets/img/brasao.png')) ?>" style="width: 50%;bottom: 20px;position: relative;">
                </div>
                <div class="col-xs-4 col-sm-4 col-md-4 right">
                    <img src="<?php echo (base_url('application/homeDaq/homeCgob/assets/img/brazilflag.png')) ?>" style="width: 25%;bottom: 10px;position: relative;">
                </div>
            </div>
