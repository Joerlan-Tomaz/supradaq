<script src="<?php echo(base_url('application/homeDaq/homeCgob/assets/js/supervisaodaq/avancofisico/avancofisicoView.js'))?>" type="text/javascript"></script>	
            ...
            <div class="card card-default">
                <div class="card-header">
                    <form method="post" name="formulario">
                        <h2>
                            <font size="3"> 
                            O avanço físico das obras será inserido na ferramenta de acordo com o andamento mensal dos serviços na obra.
                            ...
                            <div class='mostrar'>
                                ...
                                O avanço físico seguirá a mesma lógica do cronograma físico, devendo considerar cada eixo separadamente. 
                                Este será inserido por km e estaca em duas etapas, atacado e concluído. <br>
                                Este item deverá representar o fiel andamento dos serviços na obra no mês executado, totalmente desvinculado do cronograma financeiro. 
                                Desta forma o DNIT terá a informação exata do que foi executado, dos serviços a executar, 
                                da linearidade e da aderência dos serviços ao cronograma.
                            </div>
                            </font>
                        </h2>
                                ...
                                <div class="row">
                                    <div class="col-md-3">  
                                        <div class="form-group">
                                            <label>Eixo</label>
                                            <select class="form-control" name="eixo" id="eixo" required>
                                            </select>  
                                        </div> 
                                    </div>
                                    <div class="col-md-3">  
                                        <div class="form-group">
                                            <label>Obra</label>
                                            <select class="form-control" name="obra" id="obra" disabled="true">
                                    ...
                                    <div class="col-md-3">  
                                        <div class="form-group">
                                            <label>Serviço</label>
                                            <select class="form-control" name="servico" id="servico" disabled="true">
                                                <option value="" selected >Selecione</option>
                                            </select>                                        
                                        </div> 
                                    </div>
