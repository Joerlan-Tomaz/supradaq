<script src="<?php echo(base_url('application/homeDaq/homeCgob/assets/js/supervisaodaq/ensaioconstrucao/ensaioconstrucaoView.js')) ?>" type="text/javascript"></script> 	
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Ensaios Construção</li>
                    </ol>
                </div>
            </div>
        </div>
