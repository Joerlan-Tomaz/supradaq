<script src="<?php echo(base_url('application/homeDaq/homeCgob/assets/js/supervisaodaq/atividadescriticas/atividadescriticasView.js')) ?>" type="text/javascript"></script>  	
