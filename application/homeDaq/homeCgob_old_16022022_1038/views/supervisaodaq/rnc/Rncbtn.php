...
<body style="background-color: white !important; ">
        <div class="col-xs-12 col-sm-12 col-md-12 smallFont" style="padding: 10px;">
            <div class="col-xs-2 col-sm-2 col-md-2" style="margin-top: 16px;">
                <img src="<?php echo (base_url('application/homeDaq/assets/img/dnit2.png')) ?>">
            </div>
...
<div class="col-xs-12 col-sm-12 col-md-12 headerTabela fundoCinzaCabecalho"style=" color:white;">REGISTRO DE NÃO CONFORMIDADE</div>
<div class="col-xs-12 col-sm-12 col-md-12 semPadding">
    <div class="col-xs-1 col-sm-1 col-md-1 headerTabelaVertical fundoCinzaCabecalho"style=" color:white;">Identificação</div>
    <div class="col-xs-12 col-sm-12 col-md-12 pull-right tamanho100-25" style="padding: 10px; border-right: 1px solid #333;">
        <table class="col-xs-12 col-sm-12 col-md-12 tabela ">
    <?php foreach ($registronconformidadesrnc as $registronconformidadesrncanexo) {
...
<div class="col-xs-12 col-sm-12 col-md-12 headerTabela fundoCinzaCabecalho"style=" color:white;">Descrição da Ocorrência</div>
<div class="col-xs-12 col-sm-12 col-md-12 semPadding" style="min-height: 100px; border-right: 1px solid #333;">
    <div class="col-xs-1 col-sm-1 col-md-1 headerTabelaVertical fundoCinzaCabecalho"style=" color:white;">Observações</div>
    <div class="col-xs-12 col-sm-12 col-md-12 pull-right headerTabela fundoCinzaCabecalho font12print tamanho100-25" style="text-align: left; border-top: 0; border-left: 0; border-right: 0;color:white;">Problema Identificado</div>
    <div class="col-xs-12 col-sm-12 col-md-12 pull-right font12print tamanho100-25" style="min-height: 140px; font:11px/21px Arial,tahoma,sans-serif;color:black" >
        <?= $PROBLEMA ?>
    </div>
    <div class="col-xs-12 col-sm-12 col-md-12 pull-right headerTabela font12print tamanho100-25 fundoCinzaCabecalho" style=" color:white;text-align: left; border-top: 0; border-left: 0; border-right: 0; border-top: 1px solid black;">Providência</div>
    <div class="col-xs-12 col-sm-12 col-md-12 pull-right font12print tamanho100-25" style="min-height: 140px; font:11px/21px Arial,tahoma,sans-serif;color:black">
        <?= $PROVIDENCIA ?>
    </div>
</div>

<div class="col-xs-12 col-sm-12 col-md-12 headerTabela fundoCinzaCabecalho"style=" color:white;">Documentação Fotográfica</div>
...
<tbody class="center">
    <tr> <td colspan="3"><img class="img-responsive" src="<?php echo (base_url('/index_cgob.php/70bc1de8a077e52493d9c41ffaa3c051?img='.$registronconformidadesrncfotoanexo->nome_arquivo)) ?>" style="width: 100%; height: 360px;"></td>
    </tr>
</tbody>
</table>
</div>
