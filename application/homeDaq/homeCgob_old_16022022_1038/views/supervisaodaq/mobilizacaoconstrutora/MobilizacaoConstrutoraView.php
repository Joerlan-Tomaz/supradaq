<script src="<?php echo(base_url('application/homeDaq/homeCgob/assets/js/supervisaodaq/mobilizacaoconstrutora/mobilizacaoconstrutoraview.js'))?>" type="text/javascript"></script>	
            ...
            <div class="card card-default">
                <div class="card-header">
                    <form method="post" name="formulario">
                        ...
                        <h2>
                            <font size="3">
                            Deve ser utilizada a tabela constante no anexo RM -  9 e RM -  10 para informar as equipes e equipamentos que trabalharam no período que 
                            trata o relatório e compará-los com o efetivo do período anterior.
								<div class='ocultar'><u>[+/-] Leia mais...</u></div>
                            <div class='mostrar'>
                                O pessoal e equipamentos contratados pela construtora através de subempreiteiras 
                                e que executaram serviços diretamente relacionados à obra devem ser contabilizados na coluna apropriada.<br>
                                Deve ser adotada a tabela constante no RM -  11 para informar as áreas das instalações utilizadas pela empresa executora da obra 
                                no período de que trata o relatório e compará-los com o quantitativo do período anterior. <br>
                                As áreas utilizadas por eventuais subempreiteiras que executaram serviços diretamente relacionados à obra devem ser contabilizadas 
