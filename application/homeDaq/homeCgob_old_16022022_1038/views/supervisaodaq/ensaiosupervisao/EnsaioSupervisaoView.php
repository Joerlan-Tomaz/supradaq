<script src="<?php echo(base_url('application/homeDaq/homeCgob/assets/js/supervisaodaq/ensaioslaboratoriais/ensaioslaboratoriaisView.js')) ?>" type="text/javascript"></script>  
