<script src="<?php echo(base_url('application/homeDaq/homeCgob/assets/js/supervisaodaq/componenteambiental/componenteambientalView.js')) ?>" type="text/javascript"></script>  	
                    ...
                    <form method="post" name="formulario">
                        <h6>
                           O monitoramento ambiental objetiva munir a fiscalização com procedimentos que permitam identificar, 
                            ...
                            <div class='mostrar'>  
                                Neste item deve ser incluída tabela com as licenças ambientais da obra, conforme RM -  20, e 
                                também informações acerca da elaboração do PBA/PBAI.<br>
                                Caso exista Supervisão/Gerenciadora Ambiental na obra, deverão ser anexados todos os Registros de Não Conformidade lavrados, 
                                até que o seu respectivo Atestado de Conformidade seja emitido pela Supervisão Ambiental e anexado ao relatório de obras.<br>
