...
class Tb_apresentacao_supervisora extends CI_Model {
    ...
    public function RecuperaApresentacaoSupervisoraol($dados) {
          $SQL = "
                SELECT 
                c.id_contrato_obra, 
                c.nu_con_formatado as contrato, 
                c.no_empresa as nome_empresa,
                c.nu_processo as processo_adm, c.ds_objeto as objeto,
                ...
                c.Valor_Inicial_Adit_Reajustes valor_atz_pir,
                 (SELECT  convert(varchar(10),data_publi_dou,103) FROM CGOB_TB_APRESENTACAO_SUPERVISORA
                WHERE id_apresentacao_super = (SELECT MAX(id_apresentacao_super) FROM CGOB_TB_APRESENTACAO_SUPERVISORA) AND id_contrato_obra = ".$dados['id_contrato_obra'].") publi_dou,
                (SELECT  convert(varchar(10),data_publi_dou_result,103) FROM CGOB_TB_APRESENTACAO_SUPERVISORA
                WHERE id_apresentacao_super = (SELECT MAX(id_apresentacao_super) FROM CGOB_TB_APRESENTACAO_SUPERVISORA) AND id_contrato_obra = ".$dados['id_contrato_obra'].") publi_result
        ...
        public function RecuperaApresentacaoSupervisora($dados) {
          $SQL = "
                SELECT  
            ...
            FULL OUTER JOIN CGOB_TB_CONTRATO_OBRA AS co ON co.nu_con_formatado_supervisor = cs.nu_con_formatado
            FULL OUTER JOIN  CGOB_TB_APRESENTACAO_SUPERVISORA AS ca ON 
                 ca.id_apresentacao_super = (SELECT MAX(id_apresentacao_super) FROM CGOB_TB_APRESENTACAO_SUPERVISORA WHERE id_contrato_obra = ".$dados['id_contrato_obra'].") 
    ...
    //---------------------------------------------------------------------------------------
        ...
        public function RecuperaSupervisora($dados) {
          $SQL = "
                SELECT 
                c.nu_con_formatado_supervisor as contratosupervisora, 
            FROM CGOB_TB_CONTRATO_OBRA AS c 
            WHERE c.id_contrato_obra=". $dados['id_contrato_obra']."
            ";
    ...
    //---------------------------------------------------------------------------------------
    public function insereApresentacaosupervisora($dados) {
            ...
            $this->db->insert("CGOB_TB_APRESENTACAO_SUPERVISORA");
    ...
    public function recuperaPortariasFiscaisps($dados){
        $SQL = "
        SELECT
            uf.estado,
            pf.nome_fiscal,
