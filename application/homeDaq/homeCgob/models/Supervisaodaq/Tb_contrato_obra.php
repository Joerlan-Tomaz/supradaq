	...
	public function ListaContratosPorUf($uf)
	{
        ...
        SELECT 
            ...
            CASE WHEN (co.nu_con_formatado_supervisor is null or co.nu_con_formatado_supervisor like '') THEN '- -'
                ...
                END as nu_con_formatado_supervisor
        FROM CGOB_TB_CONTRATO_OBRA as co
			WHERE ds_modal in ('HIDROVIARIO','PORTUARIO') AND co.sg_uf_unidade_local = '" . $uf . "'";
        ...
        FROM CGOB_TB_CONTRATO_OBRA as co
			WHERE 
                          ds_modal in ('HIDROVIARIO','PORTUARIO') 
                          and co.ds_tip_intervencao in('OBRAS PORTUÁRIAS','OBRAS HIDROVIÁRIAS')
			  and co.ds_tip_contrato in('OBRA DE ENGENHARIA')
                          and co.sg_uf_unidade_local = '" . $uf . "'";        
