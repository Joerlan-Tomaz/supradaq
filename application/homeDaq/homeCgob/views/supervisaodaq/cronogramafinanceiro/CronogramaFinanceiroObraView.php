<script src="<?php echo(base_url('application/homeDaq/homeCgob/assets/js/supervisaodaq/cronogramafinanceiroobra/cronogramafinanceiroobraView.js'))?>" type="text/javascript"></script>
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Cronograma Financeiro de Obra</h1>
                </div>
                <div class="col-sm-6">
            ...
            <div class="card card-default">
                <div class="card-header">
                    <form method="post" name="formulario">
                        <h2>
                            <font size="3">
                            O cronograma financeiro deverá ser carimbado e assinado pelo responsável técnico da empresa executora.
								<div class='ocultar'><u>[+/-] Leia mais...</u></div>
                            <div class='mostrar'>
                                O Cronograma financeiro deverá ser inserido no SUPRA com seus valores previstos por disciplina de serviços, sem reajustes. <br>
                                Além disso, deve ser anexado o documento assinado pelo fiscal do contrato de obras que aprovou o referido cronograma.<br>
