<script src="<?php echo(base_url('application/homeDaq/homeCgob/assets/js/supervisaodaq/diarioobra/diarioobraView.js')) ?>" type="text/javascript"></script>  	
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Diário de Obra</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
            ...
            <div class="card card-default">
                <div class="card-header">
                    <form method="post" name="formulario">
                        <h2>
                            <font size="3">
                            Diário de Obra é um documento de informação, controle e orientação, preparado de forma contínua e simultânea à execução da obra, 
