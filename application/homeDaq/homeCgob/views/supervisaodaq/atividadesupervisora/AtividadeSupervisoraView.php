<script src="<?php echo(base_url('application/homeDaq/homeCgob/assets/js/supervisaodaq/atividadesupervisora/atividadesupervisoraView.js')) ?>" type="text/javascript"></script>  
                ...
                <div class="card-header">
                    <form method="post" name="formulario">
                        <h2>
                            ...
                            Além das atividades rotineiras, apresentar relatórios técnicos de consultoria solicitados pela fiscalização, 
                            pela construtora ou pela própria empresa supervisora ou gerenciadora. <br>
                            Para cada uma das atividades realizadas, indicar os trechos do lote de obras a que se referem.
                            </font>
                        </h2>
                        <div class="row">
