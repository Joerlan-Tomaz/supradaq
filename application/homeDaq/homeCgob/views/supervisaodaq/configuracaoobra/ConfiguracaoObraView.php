...
<style>
    ...
    .road-menu ul li.pendencia .road-status {    
        background: url(' <?= base_url ("application/homeDaq/assets/img/road/check-warn.png") ?> ') center center no-repeat;
...
<script src="<?php echo(base_url('application/homeDaq/homeCgob/assets/js/supervisaodaq/configuracao/configuracaoView.js'))?>"></script>
<script src="<?php echo(base_url('application/homeDaq/homeCgob/assets/js/supervisaodaq/justificativaempreendimento/justificativaempreendimento.js'))?>" type="text/javascript"></script>
<script src="<?php echo(base_url('application/homeDaq/homeCgob/assets/js/supervisaodaq/mapasituacao/mapasituacao.js" type="text/javascript'))?>"></script>
<script src="<?php echo(base_url('application/homeDaq/homeCgob/assets/js/supervisaodaq/georreferenciamento/georreferenciamento.js'))?>" type="text/javascript"></script> 
<script src="<?php echo(base_url('application/homeDaq/homeCgob/assets/js/supervisaodaq/pontodepassagem/pontodepassagem.js'))?>" type="text/javascript"></script>
<script src="<?php echo(base_url('application/homeDaq/homeCgob/assets/js/supervisaodaq/ocorrenciaprojeto/ocorrenciaprojeto.js'))?>" type="text/javascript"></script>
<script src="<?php echo(base_url('application/homeDaq/homeCgob/assets/js/supervisaodaq/diagramapontopassagem/diagramapontopassagem.js'))?>" type="text/javascript"></script>
<script src="<?php echo(base_url('application/homeDaq/homeCgob/assets/js/supervisaodaq/dadossegmento/dadossegmento.js'))?>" type="text/javascript"></script> 
<script src="<?php echo(base_url('application/homeDaq/homeCgob/assets/js/supervisaodaq/portariasfiscais/portariasfiscais.js'))?>" type="text/javascript"></script>
<script src="<?php echo(base_url('application/homeDaq/homeCgob/assets/js/supervisaodaq/art/art.js'))?>" type="text/javascript"></script>
                ...
                <div class="road-menu row">
                    <div class="col-xs-12 col-md-6">
                        <ul class="list-unstyled">
                            ...
                            <li class="geo">
                                <span class="road-ico"><img src="<?php echo(base_url('application/homeDaq/homeCgob/assets/img/road/geo.png'))?>" /></span>
                                <a href="" data-toggle="modal" onclick="rotaGeorreferenciamentoDaq()"><span>Eixos Georreferenciados</span></a>
                                <span class="road-status"></span>
                            </li>
                            <li class="pontos">
                                <span class="road-ico"><img src="<?php echo(base_url('application/homeDaq/homeCgob/assets/img/road/passagem.png'))?>" /></span>
                                <a href="" data-toggle="modal" onclick="rotaPontoPassagemDaq()"><span>Pontos de Passagem</span></a>
                                <span class="road-status"></span>
                            </li>
                            <li class="diagrama">
                                <span class="road-ico"><img src="<?php echo(base_url('application/homeDaq/homeCgob/assets/img/road/diagrama.png'))?>" /></span>
                                <a href="" data-toggle="modal" onclick="rotaOcorrenciaProjetoDaq()"><span>Ocorrências de Projeto</span></a>
                                <span class="road-status"></span>
                            </li>
                            <li>
                                <span class="road-ico"><img src="<?php echo(base_url('application/homeDaq/homeCgob/assets/img/road/resumo.png'))?>" /></span>
                          ...
                          <!--   <li class="oae">
                                <span class="road-ico"><img src="<?php echo(base_url('application/homeDaq/homeCgob/assets/img/road/oae.png'))?>"/></span>
                            ...
                            <li class="portarias">
                                <span class="road-ico"><img src="<?php echo(base_url('application/homeDaq/homeCgob/assets/img/road/port.png'))?>" /></span>
