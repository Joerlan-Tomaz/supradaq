<script src="<?php echo(base_url('application/homeDaq/homeCgob/assets/js/supervisaodaq/atividadesconstrutora/atividadesconstrutoraView.js')) ?>" type="text/javascript"></script>  
...
<div class="content-wrapper">
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Atividades da Construtora</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                       ...
                       <li class="breadcrumb-item"><a href="javascript:void(0);" onclick="rotaInfoContrato()"><?php echo $this->session->numero_contrato ?></a></li>
                        <li class="breadcrumb-item active">Atividades da Construtora</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="card card-default">
                <div class="card-header">
                    <form method="post" name="formulario">
                        <h2>
                            <font size="3"> 
                            A empresa supervisora deverá informar todos os serviços executados pela construtora no período, indicando os trechos do lote de obras a que se referem.
