<script src="<?php echo(base_url('application/homeDaq/homeCgob/assets/js/supervisaodaq/termoencerramento/termoencerramentoView.js')) ?>" type="text/javascript"></script>    
