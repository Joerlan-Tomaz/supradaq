<script src="<?php echo(base_url("application/homeDaq/homeCgob/assets/js/supervisaodaq/pgq/pgqView.js")) ?>" type="text/javascript"></script>
            ...
            <div class="card card-default">
                <div class="card-header">
                    <form method="post" name="formulario">
                        <h2>
                            <font size="3">
                            Deve ser anexado cópia do PGQ elaborado pela construtora. Caso a construtora não disponibilize o PGQ a empresa fiscalizadora deve encaminhar ofício
