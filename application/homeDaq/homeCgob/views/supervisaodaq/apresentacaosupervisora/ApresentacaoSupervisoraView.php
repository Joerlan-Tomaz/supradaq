<script src="<?php echo(base_url('application/homeDaq/homeCgob/assets/js/supervisaodaq/apresentacaosupervisora/apresentacaosupervisoraView.js'))?>" type="text/javascript"></script> 
