...
<script src="<?php echo(base_url('application/homeDaq/homeCgob/assets/js/supervisaodaq/avancofinanceiroobra/avancofinanceiroobraView.js'))?>" type="text/javascript"></script>
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Avanço Financeiro da Obra</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Avanço Financeiro da Obra</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
            ...
            <div class="card card-default">
                <div class="card-header">
                    <form method="post" name="formulario">
                        <h2>
                            <font size="3"> 
                            A supervisora deverá inserir um avanço financeiro mensal para cada um dos itens cadastrados no cronograma financeiro da obra.
								<div class='ocultar'><u>[+/-] Leia mais...</u></div>
                            <div class="mostrar">
                                Como o cronograma financeiro foi cadastrado de forma a dar uma visão gerencial da obra, <br>
                            ...
                            <table id="table_visualizar_avanco" class="table table-striped" width="100%">
                                <thead>
                                    <tr>
                                        <th>#</th> 
                                        <th>Obra</th> 
                                        <th>Serviço</th>                       <th>Tipo</th>                          <th>Valor</th>
                                        <th>Usuário</th>
                                        <th>Atualização</th>
                                        <th>Ações</th>                                                                                
                                    </tr>
