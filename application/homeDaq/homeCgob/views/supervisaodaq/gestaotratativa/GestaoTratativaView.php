<script src="<?php echo(base_url('application/homeDaq/homeCgob/assets/js/supervisaodaq/gestaotratativas/gestaotratativasView.js')) ?>" type="text/javascript"></script>   	
                ...
                <div class="card-header">
                    <form method="post" name="formulario">
                        <h2>
                            ...
                            Todas as ações relevantes determinadas em diário de obras, atas de reunião, documentos oficiais e 
                                        ...
                                        <div class="col-md-6"> 
                                            <div class="form-group">
                                                ...
                                                <select id="origem_edita" name="origem_edita" class="form-control">
                                                    ...
                                                    <option value="2">Diário de Obras</option>
