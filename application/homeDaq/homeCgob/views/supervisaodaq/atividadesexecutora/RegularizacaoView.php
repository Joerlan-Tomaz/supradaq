<script src="<?php echo(base_url('assets/js/homeDaq/homeCgob/supervisaodaq/atividadesexecutora/atividadesExecutoraView.js')) ?>"
...
<div class="content-wrapper">
	...
	<section class="content-header">
		<div class="container-fluid">
			<div class="row mb-2">
				<div class="col-sm-6">
					<h1>Atividades da Executora - Regularização</h1>
				</div>
				<div class="col-sm-6">
					<ol class="breadcrumb float-sm-right">
						...
						<li class="breadcrumb-item active">Atividades da Executora - Regularização</li>
					</ol>
				</div>
			</div>
		</div><!-- /.container-fluid -->
					...
					<form method="post" name="formulario">
						<h2>
							<font size="3">
								...
								executora no âmbito de Regularização.
				...
				<div class="card-body">
					...
					<div id="cadastroAtividadesExecutora">
						<form method="post" name="formularioAtividadesExecutora" id="formularioAtividadesExecutora">
							<input type="hidden" name="tipo_atividade" id="tipo_atividade" value="Regularização">
							<div class="row">
								<div class="col-md-12">
							...
							<div class="row">
								<div class="col-md-12">
									<div class="form-group">
										<a href='javascript:void(0);' onclick="ModeloGeo('Modelo de Formulário - Regularização.xlsx')" ><span class="right badge badge-info">Baixe o modelo de planilha</span></a>
									</div>
								</div>
							</div>
							<div class="row">
