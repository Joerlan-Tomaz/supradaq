<script src="<?php echo(base_url('application/homeDaq/homeCgob/assets/js/supervisaodaq/mobilizacaosupervisora/mobilizacaosupervisoraView.js'))?>" type="text/javascript"></script>	
            ...
            <div class="card card-default">
                <div class="card-header">
                    <form method="post" name="formulario">
                        <h6>                            
                            Devem ser informadas as equipes disponibilizadas para a realização das atividades que constituem o
                                Plano de Trabalho contratual da empresa supervisora.
							<div class='ocultar'><u>[+/-] Leia mais...</u></div>
                            <div class='mostrar'>
                                Qualquer mudança em relação ao disposto na proposta contratual deve ser comunicada no relatório.<br>
                                Devem ser utilizadas as tabelas constantes nos anexos, RM -  6 e RM -  7, 
                                para informar as equipes e equipamentos que trabalharam no período que trata o relatório e compará-los com o efetivo do período anterior. <br>
                                O pessoal e equipamentos contratados pela supervisora através de subempreiteiras e que executaram serviços diretamente relacionados 
                                à obra devem ser contabilizados na coluna apropriada. 
                            </div>
                        </h6>
                        <hr>
                        <div class="row">
