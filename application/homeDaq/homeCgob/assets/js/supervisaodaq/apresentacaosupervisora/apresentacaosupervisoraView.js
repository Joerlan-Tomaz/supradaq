...
$().ready(function () {
    ...
    $.ajax({
        type: 'POST',
        url: base_url + 'index_cgob.php/RecuperaApresentacaoSupervisoraDaq?periodo='+termo,
        dataType: 'json',
    ...
    $('#tableAsAditivo').dataTable({
        ...
        "sAjaxSource": base_url + "index_cgob.php/SupervisoraAditivoDaq",
        "aoColumns": [
    ...
    $('#tableAsFiscal').dataTable({
        ...
        "sAjaxSource": base_url + "index_cgob.php/SupervisoraFiscaisDaq?contrato_fiscalizado=Supervisão",
    ...
    $('#tableAsLocalizacao').dataTable({
        ...
        "sAjaxSource": base_url + "index_cgob.php/SupervisoraLocalizacaoDaq",
        "aoColumns": [
     ...
     $("#tableAsResponsavelTecnico").dataTable({
        ...
        "sAjaxSource": base_url + "index_cgob.php/SupervisoraRespTecnicoDaq",
        "aoColumns": [
   ...
   $('#tableAsParalisacaoReinicio').dataTable({
        ...
        "sAjaxSource": base_url + "index_cgob.php/SupervisoraReinicioDaq?id_roteiro=19",
        "aoColumns": [
...
function gravaApresentacao() {
    ...
    bootbox.confirm("Confirmar operação [EDITAR APRESENTAÇÃO]?", function (result) {
        if (result === true) {
            $.ajax({
                type: 'POST',
                url: base_url + 'index_cgob.php/insereApresentacaosupervisoraDaq',
                data: serializedData,
                dataType: 'json',
                success: function (data) {
...
function gravaAditivo() {
    ...
    bootbox.confirm("Confirmar operação [INSERIR ADITIVO]?", function (result) {
        if (result === true) {
            $.ajax({
                type: 'POST',
                url: base_url + 'index_cgob.php/insereAditivosupervisoraDaq',
                data: serializedData,
                dataType: 'json',
                success: function (data) {
    ...
    if (relatorio == 1) {
        ...
        bootbox.confirm("Confirmar operação [EXCLUIR TERMO ADITIVO]?", function (result) {
            if (result === true) {
                $.ajax({
                    type: 'POST',
                    url: base_url + 'index_cgob.php/excluirAditivoSupervioraDaq',
...
function gravaLocalizacao() {
    ...
    bootbox.confirm("Confirmar operação [INSERIR LOCALIZAÇÃO]?", function (result) {
        if (result === true) {
            $.ajax({
                type: 'POST',
                url: base_url + 'index_cgob.php/insereLocalizacaoSupervisoraDaq',
                data: serializedData,
                dataType: 'json',
                success: function (data) {
                    $.notify('Cadastrado com sucesso!', "success");
    ...
    if (relatorio == 1) {
        ...
        bootbox.confirm("Confirmar operação [EXCLUIR LOCALIZAÇÃO]?", function (result) {
            if (result === true) {
                $.ajax({
                    type: 'POST',
                    url: base_url + 'index_cgob.php/excluirLocalizacaoSupervisoraDaq',
...
function gravaResponsavelTecnico() {
    ...
    bootbox.confirm("Confirmar operação [INSERIR RESPONSÁVEL TÉCNICO]?", function (result) {
        if (result === true) {
            $.ajax({
                type: 'POST',
                url: base_url + 'index_cgob.php/insereRespTecnicoSupDaq',
                data: serializedData,
                dataType: 'json',
                success: function (data) {
    ...
    if (relatorio == 1) {
        ...
        bootbox.confirm("Confirmar operação [EXCLUIR RESPONSÁVEL TÉCNICO]?", function (result) {
            if (result === true) {
                $.ajax({
                    type: 'POST',
                    url: base_url + 'index_cgob.php/excluirResptecnicoSupDaq',
...
function btgravaParalisacaoreinicio(){
        ...
        $.ajax({
            type: 'POST',
            url: base_url + 'index_cgob.php/insereReinicioSupervisaoDaq',
            data: form,
            dataType: 'json',
            contentType: false,
            processData: false,
...
function excluirReinicio(nome_arquivo) {
    $.ajax({
        url: base_url + 'index_cgob.php/excluirReinicio',
        type: 'POST',
        data: {nome_arquivo: nome_arquivo},
        success: function (data) {
...
function excluirParalisacaoReinicio(id_paralisacaoreinicio,id_arquivo) {
    ...
    bootbox.confirm("Confirmar operação [EXCLUIR PARALISAÇÃO/REINICIO]?", function (result) {
        if (result === true) {
            $.ajax({
                type: 'POST',
                url: base_url + 'index_cgob.php/excluirReinicioSupDaq?id_paralisacaoreinicio='+id_paralisacaoreinicio+'&id_arquivo='+id_arquivo,
                dataType: 'json',
                success: function (data) {
                    $.notify('Excluido com sucesso!', "success");
                    var table = $("#tableAsParalisacaoReinicio").DataTable();
