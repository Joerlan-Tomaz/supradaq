       ...
       var id_rnc = $('#id_rnc').val();
        ...
        bootbox.confirm("Confirmar operação [INSERIR FOTOS]?", function (result) {
            if (result === true) {
                $.ajax({
                    type: 'POST',
                    url: base_url + 'index_cgob.php/RncInsereFotoDaq',
                    data: form,
                    dataType: 'json',
                    contentType: false,
                    processData: false,
    ...
    //----------------------------------------------------------------------------------------------------------------------------------------
        bootbox.confirm("Confirmar operação [NÃO HOUVE ATIVIDADES ESTE MÊS]?", function (result) {
            if (result === true) {
                $.ajax({
                    type: 'POST',
                    url: base_url + 'index_cgob.php/RncNaoAtividadeDaq',
                    data: {
                        periodo: termo
                    },
                    dataType: 'json',
...
function excluirRNC(id_rnc,id_providencia) {
    ...
    bootbox.confirm("Confirmar operação [EXCLUIR RNC]?", function (result) {
        if (result === true) {
            $.ajax({
                type: 'POST',
                url: base_url + 'index_cgob.php/RncExcluirDaq',
...
function excluiratividade(id) {
    bootbox.confirm("Confirmar operação [EXCLUIR NÃO ATIVIDADE]?", function (result) {
        if (result === true) {
            $.ajax({
                type: 'POST',
                url: base_url + 'index_cgob.php/RncExcluiAtvDaq',
                data: {id: id},
                dataType: 'json',
                success: function (data) {
                    $.notify('Excluído com sucesso!', "success");
...
function excluirProvidencia(id_providencia) {
    bootbox.confirm("Confirmar operação [EXCLUIR RNC]?", function (result) {
        if (result === true) {
            $.ajax({
                type: 'POST',
                url: base_url + 'index_cgob.php/RncExcluiProvDaq',
...
function confereNaoAtividade() {
    ...
    $.ajax({
        type: "POST",
        url: base_url + "index_cgob.php/RncConfereAtvDaq",
...
var dt = $("#datepicker").datepicker('getDate');
    ...
    jan = window.open(base_url + 'index_cgob.php/RncImpDaq?periodo=' + termo + '&id='+id_rnc, 'jan', 'STATUS=NO, TOOLBAR=NO, LOCATION=NO, DIRECTORIES=NO, RESISABLE=NO, SCROLLBARS=YES, TOP=100, LEFT=450, WIDTH=740, HEIGHT=500');
...
function fotos(id_rnc) {
    ...
    $.ajax({
        type: 'POST',
        url: base_url + 'index_cgob.php/RncFotosDaq',
        data: {id_rnc: id_rnc},
        dataType: 'json',
        success: function (data) {
            $('#nova_rnc').hide();
...
function modalSituacao(id_rnc, situacao_providencia) {
    ...
    $("#tableSugestaoRNC").dataTable({
        ...
        "sAjaxSource": base_url + "index_cgob.php/RncConsultaSugestaoDaq",
        "fnServerParams": function (aoData) {
            aoData.push(
...
function populaGravidade() {
    $.ajax({
        type: 'POST',
        url: base_url + 'index_cgob.php/RncGravidadeDaq',
        dataType: 'json',
        success: function (data) {
...
function populaNatureza() {
    $.ajax({
        type: 'POST',
        url: base_url + 'index_cgob.php/RncNaturezaDaq',
        dataType: 'json',
        success: function (data) {
...
function populaObra() {
    $.ajax({
        type: 'POST',
        url: base_url + 'index_cgob.php/RncObraDaq',
        dataType: 'json',
        success: function (data) {
...
function populaPavimento() {
    $.ajax({
        type: 'POST',
        url: base_url + 'index_cgob.php/RncPavimentoDaq',
        dataType: 'json',
        success: function (data) {
...
function populaTipoEixo() {
    $.ajax({
        type: 'POST',
        url: base_url + 'index_cgob.php/RncEixoDaq',
        dataType: 'json',
        success: function (data) {
            ...
            for (i = 0; i < data.id_eixo.length; i++) {
                servico.append('<option value="' + data.id_eixo[i] + '">' + data.desc_eixo[i] + '</option>');
            }
        }
    })
}
...
function anexoRnc(nome_arquivo) {
    $.ajax({
        url: base_url + 'index_cgob.php/anexoRnc',
        type: 'POST',
...
function insereRnc(){
        ...
        bootbox.confirm("Confirmar operação [INSERIR RNC]?", function (result) {
            if (result === true) {
                $.ajax({
                    type: "POST",
                    url: base_url + "index_cgob.php/RncInsereDaq",
                    data: {
                            grau: grau,
...
function btnInsereSolucaoRNC(){
    ...
    bootbox.confirm("Confirmar operação [INSERIR SOLUÇÃO]?", function (result) {
        if (result === true) {
            $.ajax({
                type: "POST",
                url: base_url + "index_cgob.php/RncInsereProvidenciaDaq",
                data: {
...
function RecuperaFotos(id_rnc){
    ...
    $("#tablefotos").dataTable({
        ...
        "sAjaxSource": base_url + "index_cgob.php/RncRecuperaFotoDaq?id_rnc="+id_rnc,
        "aoColumns": [
            {data: "conte"},
            {data: "foto"},
            {data: "nome_arquivo"},
...
function excluiRnc(nome_arquivo) {
    $.ajax({
        url: base_url + 'index_cgob.php/excluiRnc',
        type: 'POST',
        data: {nome_arquivo: nome_arquivo},
        success: function (data) {
...
function excluirFoto(id_rnc_foto, id_arquivo) {
    bootbox.confirm("Confirmar operação [EXCLUIR FOTO]?", function (result) {
        if (result === true) {
            $.ajax({
                type: "POST",
                url: base_url + "index_cgob.php/RncExcluirFotoDaq",
