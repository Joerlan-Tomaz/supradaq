...
function recuperaCronograma() {
	$('#table_visualizar_cronogramafinanceiroobra').dataTable({
		...
		"sAjaxSource": base_url + "index_cgob.php/CronogramaFinanceiroRetornaDaq",
		"aoColumns": [
...
function PublicarCronograma_naopublicado(id_cronograma, versao, id_cronograma_financeiro_versao) {
	bootbox.confirm("Confirmar operação [PUBLICAR CRONOGRAMA]?", function (result) {
		if (result === true) {
			$.ajax({
				type: 'POST',
				url: base_url + 'index_cgob.php/CronogramaFinanceiroPublicarDaq?id_cronograma=' + id_cronograma + '&versao=' + versao + '&id_cronograma_financeiro_versao=' + id_cronograma_financeiro_versao,
				dataType: 'json',
...
function RecuperaeditarCronograma(id_cronograma_financeiro) {
	...
	$('#table_editar_cronogramafinanceiroobra').dataTable({
		...
		"sAjaxSource": base_url + "index_cgob.php/CronogramaFinanceiroEditarDaq?id_cronograma_financeiro=" + id_cronograma_financeiro,
		"aoColumns": [
			{data: 'valor_previsto', "sClass": "text-center"},
			{data: 'usuario', "sClass": "text-center"},
			{data: 'versao', "sClass": "text-center"},
...
function saldos(id_cronograma, versao) {
	$.ajax({
		type: 'POST',
		url: base_url + 'index_cgob.php/CronogramaFinanceiroSaldoDaq?id_cronograma=' + id_cronograma + '&versao=' + versao,
		dataType: 'json',
		success: function (data) {
...
function btnInclusao() {
	...
	$.ajax({
		type: 'POST',
		url: base_url + 'index_cgob.php/CronogramaFinanceiroObraDaq',
		dataType: 'json',
		success: function (data) {
...
function insereCronogramaFinanceiroObra() {
	...
	$.ajax({
		type: 'POST',
		url: base_url + 'index_cgob.php/CronogramaFinanceiroVersaoDaq',
		dataType: 'json',
		success: function (data) {
			...
			bootbox.confirm("Confirmar operação [INSERIR CRONOGRAMA FINANCEIRO DE OBRA]?", function (result) {
				if (result === true) {
					$.ajax({
						type: 'POST',
						url: base_url + 'index_cgob.php/CronogramaFinanceiroInsereDaq',
						data: serializedData,
						dataType: 'json',
						success: function (data) {
							$('#id_cronograma').val(id_cronograma);
...
function insereCronogramaFinanceiroObraVersao(id_cronograma, versao) {
	...
	bootbox.confirm("Confirmar operação [INSERIR CRONOGRAMA FINANCEIRO DE OBRA]?", function (result) {
		if (result === true) {
			$.ajax({
				type: 'POST',
				url: base_url + 'index_cgob.php/CronogramaFinanceiroInsereVersaoDaq?id_cronograma=' + id_cronograma + '&versao=' + versao,
				data: serializedData,
				dataType: 'json',
				success: function (data) {
					$.notify('[Cronograma Financeiro Aquaviário], Cadastrado com sucesso!', "success");
...
function ExcluirAvancoInternoIncluir(id_cronograma_financeiro) {
	bootbox.confirm("Confirmar operação [EXCLUIR CRONOGRAMA]?", function (result) {
		if (result === true) {
			$.ajax({
				type: 'POST',
				url: base_url + 'index_cgob.php/CronogramaFinanceiroTrashavanDaq?id_cronograma_financeiro=' + id_cronograma_financeiro,
	...
	if ((!valor_previsto) && (!id)) {
		...
		bootbox.confirm("Confirmar operação [EDITAR CRONOGRAMA]?", function (result) {
			if (result === true) {
				$.ajax({
					type: 'POST',
					url: base_url + 'index_cgob.php/CronogramaFinanceiroGravaEditaDaq',
...
function verificaCronograma() {
	...
	$.ajax({
		type: 'POST',
		url: base_url + 'index_cgob.php/CronogramaFinanceiroRetornaDaq',
		dataType: 'json',
		async: false,
		success: function (data) {
...
function RecuperaCronogramaAgrupado() {
	...
	$('#table_visualizar_cronogramaagrupado_naopublicado').dataTable({
		...
		"sAjaxSource": base_url + "index_cgob.php/CronogramaFinanceiroNpublicadoDaq",
		"aoColumns": [
	...
	$('#table_visualizar_cronogramaagrupado_publicado').dataTable({
		...
		"sAjaxSource": base_url + "index_cgob.php/CronogramaFinanceiroPublicadoDaq",
		"aoColumns": [
			{data: 'n', "sClass": "text-center"},
			{data: 'total_pi_a', "sClass": "text-center"},
			{data: 'valor_previsto', "sClass": "text-center"},
...
function RecuperaDetalhado_naopublicado(id_cronograma, linha, conte) {
	...
	$('#table_visualizar_cronogramafinanceiroobra').dataTable({
		...
		"sAjaxSource": base_url + "index_cgob.php/CronogramaFinanceiroRetornaDaq?excluir=1&id_cronograma=" + id_cronograma,
		"aoColumns": [
			{data: 'n', "sClass": "text-center"},
...
function RecuperaDetalhado_publicado(id_cronograma, linha, conte) {
	...
	$('#table_visualizar_cronogramafinanceiroobra').dataTable({
		...
		"sAjaxSource": base_url + "index_cgob.php/CronogramaFinanceiroRetornaDaq?id_cronograma=" + id_cronograma,
		"aoColumns": [
			{data: 'n', "sClass": "text-center"},
			{data: 'obra', "sClass": "text-center"},
			{data: 'servico', "sClass": "text-center"},
...
function RecuperaDetalhadoIncluir() {
	...
	$('#table_visualizar_cronogramafinanceiroobra').dataTable({
		...
		"sAjaxSource": base_url + "index_cgob.php/CronogramaFinanceiroRetornaDaq?excluir=2&id_cronograma=" + id_cronograma,
		"aoColumns": [
			{data: 'n', "sClass": "text-center"},
			{data: 'obra', "sClass": "text-center"},
			{data: 'servico', "sClass": "text-center"},
...
function ContaNaoPublicado() {
	...
	$.ajax({
		type: 'POST',
		url: base_url + 'index_cgob.php/CronogramaFinanceiroContaNDaq',
		dataType: 'json',
		async: false,
		success: function (data) {
...
function RecuperaSevico(id_obra) {
	...
	if (id_obra !== "") {
		...
		$.ajax({
			type: 'POST',
			url: base_url + 'index_cgob.php/CronogramaFinanceiroServicoDaq',
...
function tipo(servico) {
	...
	$.ajax({
		type: 'POST',
		url: base_url + 'index_cgob.php/CronogramaFinanceiroTipoDaq',
