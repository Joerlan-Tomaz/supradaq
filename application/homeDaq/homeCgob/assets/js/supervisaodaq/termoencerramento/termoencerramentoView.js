    ...
    $("#btnInclusao").click(function () {
        ...
        if (relatorio == 1) {
           ...
           var termo = new Object();
            ...
            $.ajax({
                type: 'POST',
                url: base_url + 'index_cgob.php/TermoEncerramentoTextoDaq?periodo='+termo,
                dataType: 'json',
    ...
    $("#insereTermoEncerramento").click(function () {
        ...
        bootbox.confirm("Confirmar operação [INSERIR TERMO DE ENCERRAMENTO]?", function (result) {
            if (result === true) {
                $.ajax({
                    type: 'POST',
                    url: base_url + 'index_cgob.php/TermoEncerramentoInsereDaq',
                    data: serializedData,
                    dataType: 'json',
                    success: function (data) {
    ...
    if (relatorio == 1) {
        ...
        bootbox.confirm("Confirmar operação [EXCLUIR TERMO DE ENCERRAMENTO]?", function (result) {
            if (result === true) {
                $.ajax({
                    type: 'POST',
                    url: base_url + 'index_cgob.php/TermoEncerramentoExcluirDaq',
                    data: {
                        id_termo: id_termo
                    },
                    dataType: 'json',
...
function recuperaTermoEncerramento() {
    ...
    $('#tableTermoEncerramento').dataTable({
        ...
        "sAjaxSource": base_url + "index_cgob.php/TermoEncerramentoRecuperaDaq",
...
function editarTermoEncerramento(id_termo) {
    ...
    // } else {
        $.ajax({
            type: 'POST',
            url: base_url + 'index_cgob.php/TermoEncerramentoEditarDaq',
