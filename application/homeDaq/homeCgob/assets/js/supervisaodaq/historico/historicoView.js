   ...
   $("#insereHistorico").click(function () {
       ...
       bootbox.confirm("Confirmar operação [INSERIR HISTÓRICO]?", function (result) {
           if (result == true) {
               $.ajax({
                   type: 'POST',
                   url: base_url + 'index_cgob.php/ResumoInsereDaq',
                   data: serializedData,
                   dataType: 'json',
...
//-----------------------------------------------------------
    ...
    $('#tabelaHistorico').dataTable({
        ...
        "sAjaxSource": base_url + "index_cgob.php/ResumoRecuperaDaq?periodo="+termo,
        "aoColumns": [
...
function editarResumo(id_resumo) {
  relatorio = confereRelatorio();
    ...
    $.ajax({
        type: 'POST',
        url: base_url + 'index_cgob.php/ResumoEditarDaq',
...
function excluirHistorico(id_resumo) {
    ...
    bootbox.confirm("Confirmar operação [EXCLUIR HISTÓRICO]?", function (result) {
        if (result === true) {
            $.ajax({
                type: 'POST',
                url: base_url + 'index_cgob.php/ResumoExcluirDaq',
                data: {id_resumo: id_resumo},
                dataType: 'json',
                success: function (data) {
