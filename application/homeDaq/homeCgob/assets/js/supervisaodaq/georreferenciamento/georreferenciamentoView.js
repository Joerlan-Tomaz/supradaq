...
function recuperaGeorreferenciamento() {
	...
	$("#tableGeorreferenciamento").dataTable({
		...
		"sAjaxSource": base_url + "index_cgob.php/GeorreferenciamentoRetornoDaq",
	...
	if (relatorio == 1) {
		...
		bootbox.confirm("Confirmar operação [EXCLUIR REGISTROS DE GEORREFERENCIAMENTO DO ARQUIVO  '" + arquivo + "']?", function (result) {
			if (result === true) {
				$.ajax({
					type: "POST",
					url: base_url + "index_cgob.php/GeorreferenciamentoExcluirDaq",
...
function detalhesGeorreferenciamento(id_arquivo) {
	...
	$("#tableDetalhesGeorreferenciamento").dataTable({
		...
		"sAjaxSource": base_url + "index_cgob.php/GeorreferenciamentoDetalhesDaq",
		"fnServerParams": function (aoData) {
...
function ModeloGeo(nome_arquivo) {
    $.ajax({
        type: "POST",
        url: base_url + "index_cgob.php/GeorreferenciamentoModelo?arq="+nome_arquivo,
        data: {nome_arquivo: nome_arquivo},
        dataType: "json",
        success: function (data) {
...
function fileUploadConfigGeorreferenciamento() {
	...
	if ($("#nome_apelido").val() == "") {
		...
		$.ajax({
			type: "POST",
			url: base_url + "index_cgob.php/GeorreferenciamentoNomeEixoDaq?nome_apelido=" + nome_apelido,
			dataType: "json",
			dataType: "json",
			contentType: false,
			processData: false,
	...
	$.ajax({
		type: "POST",
		url: base_url + "index_cgob.php/GeorreferenciamentoinsereDaq",
		dataType: "json",
		data: form,
		dataType: "json",
		contentType: false,
...
function excluirGeo(nome_arquivo) {
	$.ajax({
		url: base_url + 'index_cgob.php/excluirGeo',
		type: 'POST',
		data: {nome_arquivo: nome_arquivo},
		success: function (data) {
			//$.notify('Excluido com Sucesso!', "success");
...
function populaHidrovia() {
	$.ajax({
		type: 'POST',
		url: base_url + 'index_cgob.php/GeorreferenciamentoHidroviaDaq',
		dataType: 'json',
		success: function (data) {
...
function btnInsere() {
	...
	$.ajax({
		type: "POST",
		url: base_url + "index_cgob.php/GeorreferenciamentoDadosDaq?nomeArquivo=" + nomeArquivo + "&idArquivo=" + idArquivo + "&eixo=" + eixo + "&nome_apelido=" + nome_apelido,
		dataType: "json",
		data: form,
		dataType: "json",
		contentType: false,
