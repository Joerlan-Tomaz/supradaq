...
function searchdate() {
    ...
    $('#tableRelacaoMobilizacao').dataTable({
        ...
        "sAjaxSource": base_url + "index_cgob.php/MobilizacaoSupervisoraRecuperaDaq",
        "fnServerParams":
                function (aoData) {
                    aoData.push(
...
function insereRelacaoMobilizacao() {
    ...
    bootbox.confirm("Confirmar operação [INSERIR RELAÇÃO]?", function (result) {
        if (result === true) {
            ...
            $.ajax({
                type: 'POST',
                url: base_url + 'index_cgob.php/MobilizacaoSupervisoraGravaDaq',
                data: {
                    data: serializedData,
                    periodo: termo
                },
    ...
    if (relatorio == 1) {
        ...
        bootbox.confirm("Confirmar operação [EXCLUIR]?", function (result) {
            if (result === true) {
                $.ajax({
                    type: 'POST',
                    url: base_url + 'index_cgob.php/MobilizacaoSupervisoraExcluiDaq',
                    data: {
                        id: id
                    },
                    dataType: 'json',
...
function Recupera_item() {
    $.ajax({
        type: 'POST',
        url: base_url + 'index_cgob.php/MobilizacaoSupervisoraItemDaq',
        dataType: 'json',
        success: function (data) {
...
function RecuperaRelacaoMobilizacao_Supervisora() {
    ...
    $('#tableCadastroRelacaoMobilizacao').dataTable({
        ...
        "sAjaxSource": base_url + "index_cgob.php/MobilizacaoSupervisoraRelacaoDaq?item=" + item,
