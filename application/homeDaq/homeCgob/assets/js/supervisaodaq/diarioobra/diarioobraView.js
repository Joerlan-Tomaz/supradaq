    ...
    $("#insereDiarioObra").click(function () {
        ...
        bootbox.confirm("Confirmar operação [INSERIR DIÁRIO DE OBRA]?", function (result) {
            if (result === true) {
                ...
                $.ajax({
                    url: base_url + 'index_cgob.php/DiarioObraInsereDaq',
                    type: "POST",
                    data: form,
                    dataType: 'json',
                    contentType: false,
...
function recuperaDiarioObra() {
    ...
    $('#tableDiarioObra').dataTable({
        ...
        "sAjaxSource": base_url + "index_cgob.php/DiarioObraRecuperaDaq",
...
function excluirDiario(nome_arquivo) {
    $.ajax({
        url: base_url + 'index_cgob.php/excluirDiario',
        type: 'POST',
        data: {nome_arquivo: nome_arquivo},
        success: function (data) {
    ...
    if (relatorio == 1) {
        ...
        bootbox.confirm("Confirmar operação [EXCLUIR REGISTRO]?", function (result) {
            if (result === true) {
                $.ajax({
                    type: 'POST',
                    url: base_url + 'index_cgob.php/DiarioObraExcluirDaq',
...
function confereNaoAtividade() {
    ...
    $.ajax({
        type: 'POST',
        url: base_url + 'index_cgob.php/DiarioObraRecuperaDaq',
        data: {periodo: termo},
        dataType: 'json',
        success: function (data) {
