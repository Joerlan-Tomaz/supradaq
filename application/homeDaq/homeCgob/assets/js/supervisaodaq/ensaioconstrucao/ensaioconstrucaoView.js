    ...
    $("#insereEnsaioLaboratorio").click(function () {
        ...
        bootbox.confirm("Confirmar operação [INSERIR ENSAIOS DE LABORATÓRIOS]?", function (result) {
            if (result === true) {
                $.ajax({
                    type: 'POST',
                    url: base_url + 'index_cgob.php/EnsaioConsInsereDaq',
                    data: form,
                    dataType: 'json',
                    contentType: false,
                    processData: false,
        ...
        if (relatorio == 1) {
            ...
            bootbox.confirm("Confirmar operação [NÃO HOUVE ATIVIDADES ESTE MÊS]?", function (result) {
                if (result === true) {
                    $.ajax({
                        type: 'POST',
                        url: base_url + 'index_cgob.php/insereNaoAtividadeEnConstDaq',
                        data: {periodo: termo},
                        dataType: 'json',
                        success: function (data) {
...
function recuperaEnsaios() {
    ...
    $('#tableEnsaioLaboratorio').dataTable({
        ...
        "sAjaxSource": base_url + "index_cgob.php/EnsaioConsRecuperaDaq",
...
function confereNaoAtividade() {
    ...
    $.ajax({
        type: 'POST',
        url: base_url + 'index_cgob.php/EnsaioConsRecuperaDaq',
        data: {periodo: termo},
        dataType: 'json',
        success: function (data) {
    ...
    if (relatorio == 1) {
        ...
        bootbox.confirm("Confirmar operação [EXCLUIR REGISTRO]?", function (result) {
            if (result === true) {
                $.ajax({
                    type: 'POST',
                    url: base_url + 'index_cgob.php/EnsaioConsExcluirDaq',
...
function excluirEnsaio(nome_arquivo) {
    $.ajax({
        url: base_url + 'index_cgob.php/excluirEnsaio',
        type: 'POST',
        data: {nome_arquivo: nome_arquivo},
        success: function (data) {
