...
//# 
//# DNIT
//# sicroconstrucaoView.js
//# Desenvolvedor:jordana de Alencar 
//# Data:28/01/2020 14:50 
//# 
//############################################################################ 
//--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
$().ready(function () {
...
function Recupera_item_cadastro() {
    $.ajax({
        type: 'POST',
        url: base_url + 'index_cgob.php/SicroConstrutoraRecuperaItemDaq',
        dataType: 'json',
...
function Recupera_relacao_item_cadastro() {
    ...
    $('#tablecadastraritem').dataTable({
        ...
        "sAjaxSource": base_url + "index_cgob.php/SicroConstrutoraRelacaoItemDaq?itemcadastro=" + itemcadastro +"&sicro="+sicro+"&tipo="+tipo,
    ...
    if (relatorio == 1) {
      ...
      if (document.getElementById) {
        ...
        var termo = dt.getFullYear() + "-" + ((dt.getMonth() + 1) > 9 ? (dt.getMonth() + 1) : "0" + (dt.getMonth() + 1)) + "-01";
           ...
           $.ajax({
                    type: 'POST',
                    url: base_url + 'index_cgob.php/SicroConstrutoraCadastraItemDaq?id_sicro='+id_sicro+'&periodo='+termo,
                    dataType: 'json',
                    success: function (data) {
