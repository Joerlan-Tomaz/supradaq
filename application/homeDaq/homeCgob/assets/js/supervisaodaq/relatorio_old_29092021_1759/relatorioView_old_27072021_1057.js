...
var dt = $("#datepicker").datepicker('getDate');
    ...
    $.ajax({
        ...
        success: function (data) {
             ...
             if (data.relaboracao >= 1 & data.relaboracao < 30) { 
...
function botaoRelatorio(){
	$('#botaoRelatorio').html('<button onclick="returnRelatorio()" type="button" name="GerarRelatorio" id="GerarRelatorio" type="button" class="btn btn-xs btn-block btn-sm btn-primary">Relatório</button>');
}
