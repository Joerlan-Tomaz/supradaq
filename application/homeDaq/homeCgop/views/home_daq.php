<script src="<?php echo(base_url("application/homeDaq/homeCgop/assets/js/home/home.js")) ?>"></script>
<style>
    .btn-pushmenu{
...
<?php
    ...
    $listaModulos = array
            (
                ...
                $moduloConstrucao => array("rota_Cgob()", "CGOB", "application/homeDaq/homeCgop/assets/plugins/blocs/img/3.jpg"),
                //$moduloManutencao => array("", "MANUTENÇÃO - Em desenvolvimento...", "application/homeDaq/assets/plugins/blocs/img/1.jpg"),
                $moduloOperacoes => array("", "OPERAÇÕES", "application/homeDaq/homeCgop/assets/plugins/blocs/img/4.jpg"),
            );
