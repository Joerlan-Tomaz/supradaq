...
<script src="<?php echo(base_url('application/homeDaq/homeCgop/assets/js/administracao/atualizaSupPerfilPermissao/atualizaSupPerfilPermissaoView.js')) ?>" type="text/javascript"></script>
