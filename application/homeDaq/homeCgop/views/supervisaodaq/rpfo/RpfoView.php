<script src="<?php echo(base_url("application/homeDaq/homeCgop/assets/js/supervisaodaq/rpfo/rpfoView.js")) ?>" type="text/javascript"></script> 	
            ...
            <div class="card card-default">
                <div class="card-header">
                    <form method="post" name="formulario">
                        <h2>
                            <font size="3">
                            Devem ser inseridas informações de todas as RPFO aprovadas para o contrato de operações.
								...
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											...
											<a href="#" onclick="anexoHistorico('1631135213_539.xlsx')"><span class="right badge badge-info">Baixe o modelo de planilha</span></a>
