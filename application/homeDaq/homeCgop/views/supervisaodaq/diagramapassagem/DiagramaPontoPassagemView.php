<script src="<?php echo(base_url('application/homeDaq/homeCgop/assets/js/supervisaodaq/diagramapontopassagem/diagramapontopassagemView.js'))?>" type="text/javascript"></script>	
