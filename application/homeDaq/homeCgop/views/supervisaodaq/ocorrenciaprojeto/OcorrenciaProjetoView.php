<script src="<?php echo(base_url('application/homeDaq/homeCgop/assets/js/supervisaodaq/ocorrenciaprojeto/ocorrenciaprojetoView.js'))?>" type="text/javascript"></script>
