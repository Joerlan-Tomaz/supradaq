<script src="<?php echo(base_url('application/homeDaq/homeCgop/assets/js/supervisaodaq/relatorio/relatorioView.js')) ?>"
			...
			<div class="row mb-2">
				...
				<div class="col-sm-6">
					<ol class="breadcrumb float-sm-right">
						...
						<li class="breadcrumb-item active"><a href="javascript:void(0);" onclick="rotaSupervisaoDaq()">Painel
								de Contratos</a></li>
	...
	<section class="content">
		<div class="container-fluid">
					...
					<div class="row" style="min-height: 220px;">
						...
						<div class="col-xs-1 col-sm-2 col-md-3 vcenter">
							<div class="row vcenter">
								<div class="col-md-12">
									<span class="info-box-icon circle-line nao_preenchido elaboracao"
										  data-toggle="tooltip" title="Elaboração" data-placement="top"><i
						...
						<div class="col-xs-1 col-sm-2 col-md-3 vcenter">
							<div class="row vcenter">
								<div class="col-md-12">
									<span class="info-box-icon circle-line nao_preenchido conclusao"
										  data-toggle="tooltip" title="Conclusão" data-placement="top"><i
												class="fa fa-check"></i></span>
								</div>
								<div class="col-md-12">
									<button type="button" name="Concluirrelatorio" id="Concluirrelatorio" type="button"
											class="btn btn-xs btn-block btn-sm btn-primary">Enviar
									</button>
								</div>
						...
						<div class="col-xs-1 col-sm-4 col-md-3 vcenter"
							 style="background: white;border: 2px solid silver;border-radius: 20px; height: 125px; top: 41px;">
							<div class="row vcenter">
								<div class="col-md-12" style="bottom: 35px; min-height: 100px;">
									<span class="info-box-icon circle-line nao_preenchido analisetecnica"
										  data-toggle="tooltip" title="Análise Técnica" data-placement="top"><b
												style="font-size: 13px;">Análise <br>Técnica</b></span>
									<button type="button" name="GerarResultadoTecnico" id="GerarResultadoTecnico"
											class="btn btn-xs btn-block btn-sm btn-primary">Resultado
									</button>

								</div>
								<div class="col-md-12" style="bottom: 20px;">
									<span class="info-box-icon circle-line nao_preenchido analiseestrutural"
										  data-toggle="tooltip" title="Análise Estrutural" data-placement="top"><b
												style="font-size: 13px;">Análise Estrutural</b></span>
									<button type="button" name="GerarResultadoEstrutural" id="GerarResultadoEstrutural"
											class="btn btn-xs btn-block btn-sm btn-primary">Resultado
									</button>
								</div>
							</div>
						...
						<div class="col-xs-1 col-sm-2 col-md-3 vcenter">
							<div class="row vcenter">
								<div class="col-md-12">
									<span class="info-box-icon circle-line nao_preenchido impressora"
										  data-toggle="tooltip" title="Aceite" data-placement="top"><i
			...
			<div class="row">
				...
				<div class="col-md-3">
					<div class="description-block border-right" style="min-height: 50px;">
						<b class="description-header"><span class="label_rp" style="color: gray;"></span> <span
									class="label_versao" style="color: gray;"></span> </b>
					</div>
				</div>
				<div class="col-md-3">
			...
			<div class="modal-body">
				<div class="card-body">
					<div class="box-body">
						<div class="container-fluid">
							<div class="table-responsive">
								<table id="HistoricoAnalise" class="table table-bordered table-striped table-hover "
									   style="width: 100%">
									<thead>
									<tr>
										<td style="width: 5%;">#</td>
