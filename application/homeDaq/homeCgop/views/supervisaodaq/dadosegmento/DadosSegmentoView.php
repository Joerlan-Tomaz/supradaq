            ...
            <div class="card card-default">
                <div class="card-header">
                    <form method="post" name="formulario">
                        <h6>
                             Deverão apresentar Dados Segmento contratual referente a contratos de operações que tenha BR com  Km inicial e Km Final e (Porcentagem) Inicial e Final  do trecho conforme especificação do contrato.
