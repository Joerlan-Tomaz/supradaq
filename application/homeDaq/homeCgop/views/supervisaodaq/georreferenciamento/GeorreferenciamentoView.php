<script src="<?php echo(base_url('application/homeDaq/homeCgop/assets/js/supervisaodaq/georreferenciamento/georreferenciamentoView.js'))?>" type="text/javascript"></script>
<style>
        ...
        <div class="container-fluid">
            <div class="card card-default">
                <div class="card-header">
                    <h2>
                        <font size="3">Devem ser descritos todos os componentes do objeto contratado, com informações de estaqueamento e coordenadas geográficas.
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Nome da Infraestrutura</label><br>
                                    <input  type="text"  class="form-control" id="nome_apelido" name="nome_apelido" placeholder="Nome da Infraestrutura">
                                </div>
                            </div>
<!--                            <div class="col-md-3">-->
<!--                                <div class="form-group">-->
...
<!--                            </div>-->
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <a href="<?php echo base_url("index_cgob.php/Supervisaodaq/Arquivo/Modelo") ?>?arq=Modelo_Geo_Eixo_Daq_Cgop.xlsx" download><span class="right badge badge-info">Baixe o modelo de planilha</span></a>
                                </div>
                            </div>                       
                        </div>
                    </form>
