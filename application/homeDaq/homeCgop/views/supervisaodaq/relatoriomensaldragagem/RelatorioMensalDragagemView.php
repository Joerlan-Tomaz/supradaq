<script src="<?php echo(base_url('application/homeDaq/homeCgop/assets/js/supervisaodaq/relatoriomensaldragagem/relatoriomensaldragagemView.js')) ?>" type="text/javascript"></script>
