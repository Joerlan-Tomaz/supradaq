	...
	<section id="capa" class="sheet padding-10mm">
		...
		<div class="row" style="letter-spacing: 3px; text-align: center;">
			...
			<div class="col-md-12" style="margin-top: 10%;">
				<h2><b>RELATÓRIO DE SUPERVISÃO DE OPERAÇÕES AQUAVIÁRIAS</b></h2>
			</div>
		</div>
		<br><br>
			...
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 bold">
				...
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 fullJustify table-responsive">
					<table class="tabela bordaCompleta table80" style="width: 100%;">
						<tbody>
						<?php
						if (empty($JustificativaDeEmpreendimentoTodos)){ ?>
							<tr class="center">
								<div class="alert alert-danger" role="alert">[1. JUSTIFICATIVA E APRESENTAÇÃO DO EMPREENDIMENTO] não
									cadastrado!
								</div>
							</tr>
						<?php }else{ ?>
						...
						<?php foreach ($JustificativaDeEmpreendimentoTodos as $lista) {
							
							?>
							<tr>
								<td><?= $lista->resumo ?></td>
								<td><?= $lista->ultima_alteracao ?></td>
								<td><?= $lista->nome ?></td>
		...
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 table-responsive">
				<table class="tabela bordaCompleta " style=" width: 100%;">
					<thead class="center fundoCinzaCabecalho">
					<tr>
						<td rowspan="2">INFRAESTRUTURA</td>
					...
					foreach ($Mobilizacao_SICRO_Supervisora_Pessoal as $key) {
						...
						$TIPO = $key->tipo;
						$INFRAESTRUTURA = $key->nome_infraestrutura;
						$GRUPO = $key->item;
