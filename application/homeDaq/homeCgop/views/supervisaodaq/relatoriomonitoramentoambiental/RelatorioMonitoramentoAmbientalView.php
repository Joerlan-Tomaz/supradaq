<script src="<?php echo(base_url('application/homeDaq/homeCgop/assets/js/supervisaodaq/relatoriomonitoramentoambiental/relatoriomonitoramentoambientalView.js')) ?>" type="text/javascript"></script>
