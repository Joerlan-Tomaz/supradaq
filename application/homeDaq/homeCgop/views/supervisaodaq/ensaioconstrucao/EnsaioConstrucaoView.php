<script src="<?php echo(base_url('application/homeDaq/homeCgop/assets/js/supervisaodaq/ensaioconstrucao/ensaioconstrucaoView.js')) ?>" type="text/javascript"></script> 	
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Ensaios Operação</li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="card card-default">
                    ...
                    <form method="post" name="formulario">
                        <h6>
                            ...
                            <div class='mostrar'> 
                                ...
                                responsabilidade técnica referente à supervisão das operações, conforme estabelece a Resolução n° 1.025, de 30 de outubro de 2009, do Confea.<br>
                ...
                <div class="card-body">
                    <div class="row" id="novo_ensaioConstrucao">
                    ...
                    <div id="cadastroEnsaioConstrucao">
...
<!--                                 <div class="col-md-12">
                                ...
                                <div class="col-md-12"> 
                                    <div class="form-group">
                                        ...
                                        <textarea id="ensaioConstrucao" name="ensaioConstrucao" rows="5" style="min-width: 100%"></textarea>                                                          
                                    </div> 
                                </div> 
                            </div>
                        </form> 
