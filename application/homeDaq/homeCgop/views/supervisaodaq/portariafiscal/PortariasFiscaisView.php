<script src="<?php echo(base_url('application/homeDaq/homeCgop/assets/js/supervisaodaq/portariasfiscais/portariasfiscaisView.js')) ?>"
		...
		<div class="container-fluid">
			<div class="card card-default">
				<div class="card-header">
					<h2>
						<font size="3">
							Devem ser anexadas as portarias de designação dos fiscais do DNIT responsáveis pela
							fiscalização dos contratos de supervisão e das operações hidroviárias.
							<div class='ocultar'><u>[+/-] Leia mais...</u></div>
							<div class='mostrar'>
								Caso haja alteração do fiscal do contrato, deverá ser apresentada a nova portaria de
								designação.<br>
								Devem ser anexadas, inclusive, as portarias obsoletas, sendo as mesmas identificadas
					...
					<div class="row">
						<div class="col-xs-12 col-md-1" id="incluir">
							<button type="button" name="btnInclusao" id="btnInclusao" class="btn btn-block btn-primary">
								Incluir
							</button>
						</div>
						<div class="col-xs-12 col-md-1" id="search" style="display: none;">
							<button type="button" name="searchdate" id="btnPesquisar"
									class='btn btn-block btn-secondary'><i class="far fa-arrow-alt-circle-left"></i>
								Voltar
							</button>
						</div>
						<div class="col-xs-12 col-md-1">
							<button type="button" name="searchdate" id="btnVoltar" class='btn btn-block btn-secondary'>
					...
					<div id="cadastro_portariafiscal" style="display: none;">
						<form method="post" name="formularioPortariaFiscal" id="formularioPortariaFiscal">
							...
							<div class="row">
								...
								<div class="col-md-2">
									<div class="form-group">
										...
										<div class="input-group date">
											...
											<input id="data_portaria" name="data_portaria" type="text"
								...
								<div class="col-md-2">
									<div class="form-group">
										...
										<select class="form-control" name="contrato_fiscalizado"
												id="contrato_fiscalizado">
									...
									<div class="form-group">
										...
										<div class="input-group date">
											...
											<input id="telefone" name="telefone" class="form-control" type="tel"
												   onclick="mascaraTelefone(this.value)">
										</div>
									</div>
								</div>
								<div class="col-md-4">
							...
							<div class="row">
								<div class="col-md-1">
									<br>
									<button type="button" name="inserePortariaFiscal" id="inserePortariaFiscal"
