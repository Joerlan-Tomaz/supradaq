<script src="<?php echo(base_url('application/homeDaq/homeCgop/assets/js/supervisaodaq/conclusaogeral/conclusaogeralView.js')) ?>" type="text/javascript"></script>  
                ...
                <div class="card-header">
                    <form method="post" name="formulario">
                        <h2>
                            ...
                            <div class='mostrar'>
                                A empresa supervisora deverá emitir parecer quanto à adequabilidade das equipes, equipamentos e instalações. <br>
