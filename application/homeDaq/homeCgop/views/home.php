...
$listaModulos = array
(
		$moduloConstrucaoDif => array("rotaDif()", "DIF", "assets/plugins/blocs/img/DIF.jpg"),
		$moduloConstrucaoDaq => array("rotaDaq()", "DAQ", "assets/plugins/blocs/img/DAQ.jpg"),
);
...
<footer style="position: absolute;
    ...
    padding: 20px;">
	<p class="text-right">
		<img src="<?php echo(base_url('assets/img/logos_dnit_cinza_semfundo.png')) ?>" width="20%">
	</p>
</footer>
