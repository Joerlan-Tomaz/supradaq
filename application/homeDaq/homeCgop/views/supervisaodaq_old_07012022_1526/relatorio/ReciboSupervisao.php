...
<link rel="stylesheet" href="<?php echo (base_url('assets/css/homeDaq/homeCgop/recibo/estilos.css')) ?>" />
<link rel="stylesheet" href="<?php echo (base_url('assets/css/homeDaq/homeCgop/recibo/bootstrap.min.css')) ?>" />
<link rel="stylesheet" href="<?php echo (base_url('assets/css/homeDaq/homeCgop/recibo/print.css')) ?>" />
<style>
