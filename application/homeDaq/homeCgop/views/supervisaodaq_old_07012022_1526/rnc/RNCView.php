<script src="<?php echo(base_url('application/homeDaq/homeCgop/assets/js/supervisaodaq/rnc/rncView.js')) ?>" type="text/javascript"></script>
							...
							<div class="row">
								<div class="col-12 col-md-4">
									...
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												<label>Nome da Infraestrutura / Eixo</label>
