<script src="<?php echo(base_url('application/homeDaq/homeCgop/assets/js/supervisaodaq/apresentacaosupervisora/apresentacaosupervisoraView.js'))?>" type="text/javascript"></script> 
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Apresentação Supervisora</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Apresentação Supervisora</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
            ...
            <div class="card card-default">
                <div class="card-header">
                    <form method="post" name="formulario">
                        <h2>
                            <font size="3"> Nesta seção devem ser fornecidas, as informações referentes à identificação da empresa supervisora.
                            </font>
                        </h2>
                        <div class="row">
                            <div class="col-xs-12 col-md-1">
                                <div>
                                    <button type="button" class="btn btn-block btn-primary" id="abreApresentacao" id="abreApresentacao">Editar</button>
                                </div>
                                <div> 
                ...
                <div class="card-body">
                    <div id="exibeApresentacaoSupervisora" style="display:none">
                        <div class="row invoice-info">                                        
                            <div class="col-sm-4 invoice-col">
                                <dl>
                                    <dt>Contrato Supervisão</dt>
                ...
                <form method="post" name="formularioApresentacao" id="formularioApresentacao">
                    <div class="row">
                        <div class="col-sm-4">
                            ...
                            <div class="form-group">
                                <label>Objeto</label>
                                <textarea rows="12" cols="50" type="text" id="objeto_contrato" name="objeto_contrato" maxlength='2000' class="form-control" placeholder="Objeto"></textarea>
                            </div>
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group date">
                                        ...
                                        <input id="valor_aditado" name="valor_aditado" class="form-control" maxlength='20' onkeydown="FormataMoeda(this, 15, event)" onkeypress="return maskKeyPress(event)">
                                    </div>
                                </div>                           
                            </div>
                            <div class="col-sm-12">
                    ...
                    <div class="row">                   
                        ...
                        <div class="col-sm-4">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="hidrovia" name="hidrovia" placeholder="Hidrovia">
                            </div>

                            <div class="form-group">
                                <label>PNV Inicial</label>
                                <input type="text" class="form-control" id="pnv_inicial" name="pnv_inicial" placeholder="PNV Inicial">
                            </div>
                        ...
                        <div class="col-sm-4">
                          ...
                          <div class="col-sm-4"> 
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="km_final" name="km_final" placeholder="Km Final">
                            </div>
                          </div>
