					...
					<div id="cadastroAtividadesExecutora">
						<form method="post" name="formularioAtividadesExecutora" id="formularioAtividadesExecutora">
							...
							<div class="row">
								<div class="col-md-3">
									<div class="form-group">
										<a href="<?php echo base_url("index_cgob.php/Supervisaodaq/Arquivo/Modelo") ?>?arq=Modelo de Formulário - Regularização.xlsx" download><span class="right badge badge-info">Baixe o modelo de planilha IP4</span></a>
									</div>
								</div>
							</div>
							<div class="row">
