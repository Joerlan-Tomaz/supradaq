<script src="<?php echo(base_url('application/homeDaq/homeCgop/assets/js/supervisaodaq/atascorrespondencias/atascorrespondenciasView.js')) ?>"
						...
						<h2>
							<font size="3">
								...
								<div class='mostrar'>
									...
									(Convenente, empresa executora, supervisão, fiscalização, sociedade civil, etc). <br>
