<script src="<?php echo(base_url('application/homeDaq/homeCgop/assets/js/supervisaodaq/controlepluviometrico/controlepluviometricoView.js')) ?>"
			...
			<div class="card card-default">
				<div class="card-header">
					<form method="post" name="formulario">
						<h6>
							O controle pluviométrico deverá ser incluído diariamente no SUPRA. Este controle deverá
							conter todos os dias do mês (inclusive os domingos e feriados).
				...
				<div class="card-body">
					<div class="row" id="novo_controlepluviometrico">
						<div class="col-md-12 table-responsive">
							...
							<a class="dias" style="border: 2px solid #ADD8E6;padding: 2px; background-color: #ADD8E6; color: #ADD8E6">XX</a> Bom&nbsp;&nbsp;
							<a class="dias" style="border: 2px solid #6495ED;padding: 2px; background-color: #6495ED; color: #6495ED">XX</a> Chuva&nbsp;&nbsp;
							<a class="dias" style="border: 2px solid #0000CD;padding: 2px; background-color: #0000CD; color: #0000CD">XX</a> Impraticável&nbsp;&nbsp;
							<a class="dias" style="border: 2px solid #20B2AA;padding: 2px; background-color: #20B2AA; color: #20B2AA">XX</a> Instavel&nbsp;&nbsp;
					...
					<div class="row" id="cadastroControlePluviometrico">
						<div class="col-md-12">
							<form method="post" name="formularioControlePluviometrico"
								  id="formularioControlePluviometrico">
								<input type="hidden" name="infraestrutura" id="infraestrutura" value="" />
								<table id="tableCadastroControlePluviometrico" class="table table-striped"
									   style="width: 100%;">
									<thead>
									<tr>
						...
						<div class="col-md-1">
							<button type="button" name="insereControlePluviometrico" id="insereControlePluviometrico"
