...
<script src="<?php echo(base_url('application/homeDaq/homeCgop/assets/js/supervisaodaq/cronograma/cronogramaView.js'))?>"></script>

<!--CRONOGRAMA-->
<script src="<?php echo(base_url('application/homeDaq/homeCgop/assets/js/supervisaodaq/cronogramafisico/cronogramafisico.js'))?>"></script>
<script src="<?php echo(base_url('application/homeDaq/homeCgop/assets/js/supervisaodaq/cronogramafinanceiroobra/cronogramafinanceiroobra.js"'))?>"></script>
                    ...
                    <div class="col-xs-12 col-md-6">
                        <ul class="list-unstyled">
                            ...
                            <li class="justificativa">
                                ...
                                <a href="javascript:void(0);" onclick="rotaCronogramaFinanceiroObra()"><span>Cronograma Financeiro da Operação </span></a>
                    ...
                    <div class="col-xs-12 col-md-6">
                        <div class="road-info">
                            <div class="box-info">
                                <h3 style="width:100%">
                                    <font size="1"> 
                                    Antes do início da operação, o responsável técnico deverá realizar o planejamento dos serviços que serão executados
                                    ao longo do tempo.
                                    <br>Este deverá ser dividido em cronograma financeiro (cronograma de desembolso) e cronograma físico.
                                    </font>
                                </h3>
                                <span id="checkCronograma_financeiro_obra" class="badge badge-secondary" style="border-radius: 50px; box-shadow: 1px 3px 7px #545454; margin: 0px 10px;" data-toggle="tooltip" title="Pendente" data-placement="top"><i class="fa fa-check"></i></span> Cronograma Financeiro da Operação<br>
