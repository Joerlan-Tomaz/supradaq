...
function buscaTabelaPerfil(){
	$('#tabelaPerfil').dataTable({
		...
		"sAjaxSource": base_url + "index_cgob.php/painelAdmRecuperaPerfil",
		"aoColumns": [
...
function buscaTelas(id_perfil){
	$.ajax({
		type: "POST",
		url: base_url + "index_cgob.php/painelAdmTelas",
...
function inserirPerfil(){
	...
	bootbox.confirm("Confirmar operação [INSERIR PERFIL]?", function (result) {
		if (result === true) {
			$.ajax({
				type: "POST",
				url: base_url + "index_cgob.php/painelAdmInserirPerfil",
				data: serializedData,
				dataType: "json",
				success: function (data) {
...
function inserirTela(){
	...
	bootbox.confirm("Confirmar operação [INSERIR TELA]?", function (result) {
		if (result === true) {
			$.ajax({
				type: "POST",
				url: base_url + "index_cgob.php/painelAdmInserirTela",
				data: serializedData,
				dataType: "json",
				success: function (data) {
					$.notify("Cadastrado com sucesso!", "success");
...
function populaPerfil(id_usuario) {
	$.ajax({
		type: 'POST',
		url: base_url + 'index_cgob.php/painelAdmPopulaPerfil',
		dataType: 'json',
...
function alteraPerfilTelas(){
	...
	bootbox.confirm("Confirmar operação [VINCULAR TELA(S) AO PERFIL]?", function (result) {
		if (result === true) {
			$.ajax({
				type: "POST",
				url: base_url + "index_cgob.php/painelAdmVincularPerfilTela",
				data: serializedData,
				dataType: "json",
				success: function (data) {
					$.notify("Cadastrado com sucesso!", "success");
