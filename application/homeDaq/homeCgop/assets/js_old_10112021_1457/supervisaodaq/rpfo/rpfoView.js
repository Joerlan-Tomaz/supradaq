...
$().ready(function () {
   ...
   /* $("#numero").select2({
	...
	$('#local').on('change', function() {
		...
		$.ajax({
			url: base_url + 'index_cgop.php/RpfoStatusDaq',
			type: 'POST',
			dataType: 'json',
			data: {uf: this.value},
        ...
        if (relatorio == 1) {
            ...
            bootbox.confirm("Confirmar operação [NÃO HOUVE ATIVIDADES ESTE MÊS]?", function (result) {
                if (result === true) {
                    $.ajax({
                        type: "POST",
                        url: base_url + "index_cgop.php/RpfoinsereNaoAtividadeDaq",
                        data: {periodo: termo},
                        dataType: "json",
...
function recuperaRpfo() {
    ...
    $('#tableRpfo').dataTable({
        ...
        "sAjaxSource": base_url + "index_cgop.php/RpfoRecuperaDaq?periodo="+termo,
	...
	if (relatorio == 1) {
		...
		bootbox.confirm("Confirmar operação [EXCLUIR RPFO]?", function (result) {
			if (result === true) {
				$.ajax({
					type: 'POST',
					url: base_url + 'index_cgop.php/RpfoExcluirDaq',
...
function populaLocal() {
    $.ajax({
        type: 'POST',
        url: base_url + 'index_cgop.php/RpfoLocalDaq',
        dataType: 'json',
        success: function (data) {
...
function anexoRpfo(nome_arquivo) {
    ...
    $.ajax({
        url: base_url + 'index_cgop.php/anexoRpfo',
        type: 'POST',
...
function confereNaoAtividade() {
    ...
    $.ajax({
        type: 'POST',
        url: base_url + 'index_cgop.php/RpfoConfereAtvDaq',
        data: {periodo: termo},
        dataType: 'json',
        success: function (data) {
...
function modalStatusDetalhado(id_rpfo) {
    $.ajax({
        type: 'POST',
        url: base_url + 'index_cgop.php/RpfoStatusDetalhadoDaq',
        data: {id_rpfo: id_rpfo},
        dataType: 'json',
        success: function (data) {
...
//------------------ Verificação de campos -----------------------------
        ...
        bootbox.confirm("Confirmar operação [INSERIR RPFO]?", function (result) {
            if (result === true) {
                $.ajax({
                    type: "POST",
                    url: base_url + "index_cgop.php/RpfoInsereDaq",
                    data: form,
                    dataType: "json",
                    contentType: false,
                    processData: false,
...
function editarRpfo(id_rpfo){
  relatorio = confereRelatorio();
    ...
    $.ajax({
        type: 'POST',
        url: base_url + 'index_cgop.php/RpfoEdicaoDaq',
        data: {id_rpfo: id_rpfo},
        dataType: 'json',
        success: function (data) {
...
//------------------ Verificação de campos -----------------------------
        ...
        bootbox.confirm("Confirmar operação [EDITAR RPFO]?", function (result) {
            if (result === true) {
                $.ajax({
                    type: "POST",
                    url: base_url + "index_cgop.php/RpfoAlteraDaq?id_rpfo="+id_rpfo,
                    data: form,
                    dataType: "json",
                    contentType: false,
                    processData: false,
...
function insereRPFOHistorico(){
	...
	bootbox.confirm("Confirmar operação [INSERIR RPFO]?", function (result) {
		if (result === true) {
			$.ajax({
				type: "POST",
				url: base_url + "index_cgop.php/RpfoInsereHistorico",
				data: form,
				dataType: "json",
				contentType: false,
				processData: false,
...
function recuperaRpfoHistorico(id_rpfo) {
	...
	$('#tableRpfoHistorico').dataTable({
		...
		"sAjaxSource": base_url + "index_cgop.php/RpfoRecuperaHistorico?id_prfo=" + id_rpfo ,
		"fnServerParams": function (aoData) {
...
function insereRPFOAnexo(){
	...
	bootbox.confirm("Confirmar operação [INSERIR ARQUIVO NO RPFO]?", function (result) {
		if (result === true) {
			$.ajax({
				type: "POST",
				url: base_url + "index_cgop.php/RpfoInserirArquivo",
				data: form,
				dataType: "json",
				contentType: false,
				processData: false,
...
function recuperaRpfoAnexo(id_rpfoHistorico) {
	...
	$('#tableRpfoAnexo').dataTable({
		...
		"sAjaxSource": base_url + "index_cgop.php/RpfoRecuperaAnexo?id_prfoHistorico=" + id_rpfoHistorico ,
		"fnServerParams": function (aoData) {
...
function modelorpfo(nome_arquivo) { 
	$.ajax({
        type: "POST",
        url: base_url + "index_cgop.php/RpfoModelo",
        data: {nome_arquivo: nome_arquivo},
        dataType: "json",
        success: function (data) {
...
function anexoHistorico_old_12102021_1129(nome_arquivo) {
	$.ajax({
		url: base_url + 'index_cgop.php/anexoGeo',
		type: 'POST',
		data: {nome_arquivo: nome_arquivo},
		success: function (data) {
			var arquivo = base_url+'/arquivoDaq/arq/'+nome_arquivo;
	...
	if (relatorio == 1) {
		...
		bootbox.confirm("Confirmar operação [EXCLUIR HISTÓRICO RPFO]?", function (result) {
			if (result === true) {
				$.ajax({
					type: 'POST',
					url: base_url + 'index_cgop.php/RpfoExcluirHistorico',
	...
	if (relatorio == 1) {
		...
		bootbox.confirm("Confirmar operação [EXCLUIR ANEXO DO RPFO]?", function (result) {
			if (result === true) {
				$.ajax({
					type: 'POST',
					url: base_url + 'index_cgop.php/RpfoExcluirAnexo',
