    ...
    $.ajax({
        ...
        success: function (data) {
            $('#nova_rnc').hide();
                ...
                document.getElementById("descricao_foto02").value = "";
                document.getElementById("descricao_foto03").value = "";
                document.getElementById("uploadPreview0").src = base_url + "application/homeDaq/homeCgop/assets/img/users/default_photo.png";
                document.getElementById("uploadPreview1").src = base_url + "application/homeDaq/homeCgop/assets/img/users/default_photo.png";
                document.getElementById("uploadPreview2").src = base_url + "application/homeDaq/homeCgop/assets/img/users/default_photo.png";
                document.getElementById("uploadPreview3").src = base_url + "application/homeDaq/homeCgop/assets/img/users/default_photo.png";
                document.getElementById("fancyFoto0").href = base_url + "application/homeDaq/homeCgop/assets/img/users/default_photo.png";
                document.getElementById("fancyFoto1").href = base_url + "application/homeDaq/homeCgop/assets/img/users/default_photo.png";
                document.getElementById("fancyFoto2").href = base_url + "application/homeDaq/homeCgop/assets/img/users/default_photo.png";
                document.getElementById("fancyFoto3").href = base_url + "application/homeDaq/homeCgop/assets/img/users/default_photo.png";
