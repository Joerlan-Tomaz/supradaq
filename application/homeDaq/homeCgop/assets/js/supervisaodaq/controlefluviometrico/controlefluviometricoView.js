				...
				$.ajax({
					...
					success: function (data) {
						...
						if(eclusa == 'sim'){
							...
							$("#ip4").attr('onclick', 'editar("null", "não");');
						...
						for (i = 1; i <= lastDay; i++) {
							...
							cols += "   <select class='form-control' name='cp_manha_" + i + "' id='cp_manha_" + i + "' required>";
							cols += "       <option value='Selecione'>Selecione.. </option>";
							cols += "       <option value='Em Operação'>Em Operação</option>";
							cols += "       <option value='Fora de Operação'>Fora de Operação</option>";
							cols += "       <option value='Não Aplicável'>Não Aplicável</option>";
							cols += "   </select>";
							cols += "</td>";
						        
							cols += "<td style='text-align: center;'>Fábrica de Gelo</td>";
							cols += "<td>";
							cols += "   <select class='form-control' name='cp_tarde_" + i + "' id='cp_tarde_" + i + "' required>";
							cols += "       <option value='Selecione'>Selecione.. </option>";
							cols += "       <option value='Em Operação'>Em Operação</option>";
