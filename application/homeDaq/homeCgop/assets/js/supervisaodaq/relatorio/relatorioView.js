...
function conclusao(termo) {
    $.ajax({
        type: 'POST',
        url: base_url + 'index_cgop.php/RelatorioConclusaoDaq',
        data: {
            periodo: termo
        },
        dataType: 'json',
...
function analisetecnica(termo) {
    $.ajax({
        type: 'POST',
        url: base_url + 'index_cgop.php/RelatorioTecnicaDaq',
        data: {
            periodo: termo
        },
        dataType: 'json',
...
function analiseestrutural(termo) {
    $.ajax({
        type: 'POST',
        url: base_url + 'index_cgop.php/RelatorioEstruturalDaq',
        data: {
            periodo: termo
        },
        dataType: 'json',
...
function imprimir() {
    ...
    $.ajax({
        type: 'POST',
        url: base_url + 'index_cgop.php/RelatorioImprimirDaq',
        data: {
            periodo: termo
        },
        dataType: 'json',
...
function perfil() {
    $.ajax({
        type: 'POST',
        url: base_url + 'index_cgop.php/RelatorioValidaDaq',
        dataType: 'json',
        async: false,
        success: function (data) {
            retorno = data;
    ...
    //----------------------------------------------------------------------------------------------------------------//
        bootbox.confirm("Confirmar a operação [ENVIAR RELATORIO]?", function (result) {
            if (result === true) {
                $.ajax({
                    type: 'POST',
                    url: base_url + 'index_cgop.php/RelatorioFinalizarDaq?periodo='+termo,
                    dataType: 'json',
                    success: function (data) {
...
function returnRecibo() {
    ...
    jan = window.open(base_url + 'index_cgop.php/RelatorioReciboDaq?periodo=' + termo, 'jan', 'STATUS=NO, TOOLBAR=NO, LOCATION=NO, DIRECTORIES=NO, RESISABLE=NO, SCROLLBARS=YES, TOP=100, LEFT=left, WIDTH=800, HEIGHT=500');
}
...
function GerarResultado() {
    jan = window.open(base_url + 'index_cgop.php/RelatorioResultadoModalDaq', 'jan', 'STATUS=NO, TOOLBAR=NO, LOCATION=NO, DIRECTORIES=NO, RESISABLE=NO, SCROLLBARS=YES, TOP=100, LEFT=left, WIDTH=800, HEIGHT=500');
}
...
function botaoRecibo(){
	$('#botaoRecibo').html('<button onclick="returnRecibo()" type="button"  name="GerarRecibo" id="GerarRecibo" class="btn btn-block btn-xs btn-sm btn-primary">Recibo</button>');
}
//#----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------#
