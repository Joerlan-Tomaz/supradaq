    ...
    $("#inserePGQ").click(function () {
        ...
        bootbox.confirm("Confirmar operação [INSERIR PGQ]?", function (result) {
            if (result === true) {
                ...
                $.ajax({
                    url: base_url + "index_cgop.php/PGQInsereDaq",
                    type: "POST",
                    data: form,
                    dataType: "json",
                    contentType: false,
...
function recuperaPGQ() {
   document.getElementById("datepicker").disabled = false;
    ...
    $('#tablePGQ').dataTable({
        ...
        "sAjaxSource": base_url + "index_cgop.php/PGQRecuperaDaq",
    ...
    // } else {
        ...
        bootbox.confirm("Confirmar operação [EXCLUIR REGISTRO]?", function (result) {
            if (result === true) {
                $.ajax({
                    type: 'POST',
                    url: base_url + 'index_cgop.php/PGQExcluirDaq',
...
function excluirPgq(nome_arquivo) {
    $.ajax({
        url: base_url + 'index_cgop.php/excluirPgq',
        type: 'POST',
        data: {nome_arquivo: nome_arquivo},
        success: function (data) {
