...
public function insereArquivo($dados) {
     ...
     public function recuperaArquivo($dados) {
      ...
      public function statusOperacao($dados) {
         
        date_default_timezone_set('America/Sao_Paulo');
        $this->db->where("id_arquivo", $dados['id_arquivo']);
        $this->db->set("id_status_operacao", $dados['id_status_operacao']);
        $this->db->set("id_usuario_status_operacao", $dados['id_usuario_status_operacao']);
        $this->db->update("CGOB_TB_ARQUIVO");
        return true;
    }
    
      public function tipoInfra($dados) {
      ...
      public function statusFabricaGelo($dados) {
         
        date_default_timezone_set('America/Sao_Paulo');
        $this->db->where("id_arquivo", $dados['id_arquivo']);
        $this->db->set("id_status_fabrica_gelo", $dados['id_status_fabrica_gelo']);
        $this->db->set("id_usuario_status_operacao", $dados['id_usuario_status_operacao']);
        $this->db->update("CGOB_TB_ARQUIVO");
        return true;
    }
