...
class Tb_apresentacao_construtora_aditivo extends CI_Model {
...
public function __construct()
    ...
    public function insereAditivo($dados) {
          ...
          $this->db->set("id_roteiro", $dados["roteiro"]);
	        ...
	        $this->db->insert("CGOB_TB_APRESENTACAO_CONSTRUTORA_ADITIVO");
	...
	public function Tableaditivo($dados) {
        $SQL = "
          SELECT
            l.id_termo_aditivo, 
            l.numero_termo,
            l.desc_objeto_termo as descricao,
            ...
            FROM CGOB_TB_APRESENTACAO_CONSTRUTORA_ADITIVO AS l
    ...
    public function modalObjetoMotivacaoAditivo($dados) {
        $SQL = "
          SELECT
            ...
            FROM CGOB_TB_APRESENTACAO_CONSTRUTORA_ADITIVO AS r
     ...
     public function excluirAditivo($dados) {
        ...
        $this->db->update("CGOB_TB_APRESENTACAO_CONSTRUTORA_ADITIVO");
        return true;
    }
