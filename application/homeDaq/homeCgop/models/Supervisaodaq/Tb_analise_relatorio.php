...
//-------------------------------------------------------------------------------------------------------
	public function recuperarHistoricoAnalises($dados)
	{
        ...
        (SELECT nome_tela FROM CGOB_TB_TELAS_FORMULARIO  WHERE id_tela_formulario = ad.id_roteiro) AS modulo,
...
//-------------------------------------------------------------------------------------------------------
	public function confereStatusAnalise($dados)
	{
        ...
        FROM CGOB_TB_HISTORICO_RELATORIO
              WHERE publicar = 'S' AND id_contrato_obra = '" . $dados["id"] . "' 
              AND id_aceite in ('retificado')
      ";
