...
class Localizacao extends CI_Controller {
    ...
    public function insereLocalizacao() {
        ...
        if (empty($dados["id_localizacao"])) {
            $retorno = $this->Tb_apresentacao_construtora_localizacao->insereLocalizacao($dados);
        }
    ...
    public function Tablelocalizacao() {
        ...
        $Dados = $this->Tb_apresentacao_construtora_localizacao->Tablelocalizacao($dados);   
        $retorno["data"] = Array();
     ...
     public function excluirLocalizacao() {
        ...
        $retorno = $this->Tb_apresentacao_construtora_localizacao->excluirLocalizacao($dados);
        echo (json_encode($retorno));
    }
