...
//-------------------------------------------Insere-----------------------------------------
    ...
    public function insereAditivo() {
        ...
        if (empty($dados["id_termo_aditivo"])) {
            $retorno = $this->Tb_apresentacao_supervisora_aditivo->insereAditivo($dados);
        }
...
//-------------------------------------------Recupera-----------------------------------------
 ...
 public function Tableaditivo() {
      ...
      public function modalObjetoMotivacaoAditivo() {
        ...
        $DadosServico = $this->Tb_apresentacao_supervisora_aditivo->modalObjetoMotivacaoAditivo($dados);
      ...
      public function excluirAditivo() {
        ...
        $retorno = $this->Tb_apresentacao_supervisora_aditivo->excluirAditivo($dados);
        echo (json_encode($retorno));
    }
