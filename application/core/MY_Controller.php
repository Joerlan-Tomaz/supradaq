...
abstract class ControllerRelatorioMensalCgmrr extends ControllerCgmrr
{
    ...
    public function __construct()
    {
        ...
        if(strpos($_SERVER["SCRIPT_NAME"],"index.php") === false)
        {
            ...
            $this->load->model('analise_relatorio');
            $this->load->model('tb_status_options');
            $this->load->model('LiberaItens');
        } 
        else
        {
...
abstract class ControllerCgmrrGestaoSistema extends ControllerCgmrr
{
    ...
    public function __construct()
    {
        ...
        $this->load->model('menu');
        $this->setViewVar('menu', $this->menu->menuLeftGestaoSistema(3, $this->session->id_usuario));
    }
...
abstract class ControllerCgmrr extends MY_Controller
{
    ...
    public function __construct()
    {
        ...
        if(strpos($_SERVER["SCRIPT_NAME"],"index.php") === false)
        {
            $this->load->model('tb_historico_status');
        } 
        else
        {
