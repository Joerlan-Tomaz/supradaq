...
if (!isset($is_ajax) or $is_ajax === false) {
    ...
    <script src="<?php echo (base_url('assets/js/homeDir/home.js')) ?>"></script>
    <script src="<?php echo (base_url('assets/js/homeAssessoria/home.js')) ?>"></script>
    <script src="<?php echo (base_url('assets/js/homeImr/home.js')) ?>"></script>
    <!-- daterangepicker 
