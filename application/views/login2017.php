    ...
    <body>
        ...
        <div class="conteudo">
            <div class="conteudo-container">
                ...
                <div class="row">
                    <div class="col-sm-6 text-center"><button id="btn-login" class="btn btn-primary btn-lg btn-flat btn-block btn-login shadow"><i class="fa fa-sign-in pull-left" aria-hidden="true"></i> Acessar</button></div>
                    <div class="col-sm-6 text-center"><button id="btn-video" class="btn btn-default btn-lg btn-flat btn-block btn-video shadow"><i class="fa fa-play pull-left" aria-hidden="true"></i> Vídeo</button></div>
                </div>
            </div>
        </div>

        <div class="p-cidadao">
            <a href="https://servicos.dnit.gov.br/portalcidadao" target="_blank" class="btn btn-link">Portal Cidadão</a>
        </div>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <p>
                                ...
                                <br /> Para saber mais sobre a plataforma acesse: <a href="<?php echo (base_url('assets/downloads/supra.zip')) ?>"> Apresentações e Manual </a>, para outros esclarecimentos envie um e-mail para: <a id="emailSolicitacao" href=""> </a>.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="mensagem-acesso-envio hidden">
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <p>
                                Para saber mais sobre a plataforma acesse: <a href="<?php echo (base_url('assets/downloads/supra.zip')) ?>"> Apresentações e Manual </a>, para esclareciemntos envie um e-mail para: <a href="mailto:suporte.supra@dnit.gov.b"> suporte.supra@dnit.gov.br </a>.
                            </p>
                        </div>
                    </div>
                </div>
