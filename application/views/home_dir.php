<style>
    ...
    /* figure.effect-lily.disabled:hover figcaption > div {
        background-color: rgba(0,0,0,.6);
    }

    figure.effect-lily.disabled:hover img {
    ...
    figure.effect-lily.disabled:hover img,
    figure.effect-lily.disabled:hover h2,
    figure.effect-lily.disabled:hover p {
...
<?php
    ...
    $moduloConstrucao = "Construção";
    $moduloManutencao = "Manutenção";
    $moduloOperacoes = "Operações";

    $listaModulos = array
            (
                $moduloAssessoria => array("rota_Assessoria()", "DIR", "assets/plugins/blocs/img/2.jpg"),
                $moduloConstrucao => array("rota_Cgcont()", "CGCONT", "assets/plugins/blocs/img/3.jpg"),
                $moduloManutencao => array("rota_Cgmrr()", "CGMRR", "assets/plugins/blocs/img/1.jpg"),
                $moduloOperacoes => array("rota_Cgpert()", "CGPERT", "assets/plugins/blocs/img/4.jpg"),
            );
...
<?php } ?>
<!-- float-action-button -->
<script src="<?php echo (base_url('assets/plugins/floating-action-button/src/js/index.js')) ?>"></script>
<footer>
    <p class="text-right">
