...
<?php 
    ...
    $listaModulos = array
            (
                $moduloAssessoria => array("rotaDir()", "DIR", "assets/plugins/blocs/img/2.jpg"),
                $moduloConstrucao => array("rotaCgcont()", "CGCONT", "assets/plugins/blocs/img/3.jpg"),
                $moduloManutencao => array("rotaCgmrr()", "CGMRR", "assets/plugins/blocs/img/1.jpg"),
                $moduloOperacoes => array("rotaCgpert()", "CGPERT", "assets/plugins/blocs/img/4.jpg"),
            );
